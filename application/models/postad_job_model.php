       ...
       public function postad_creat(){
             /*AD type business or consumer*/
              ...
              if ($this->input->post('package_type') == '3') {
                ...
                $this->db->where("category_id = '1' AND sub_cat_id = 27 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 27 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 27 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 27 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /*banking */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 30 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 30 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 30 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 30 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* news and media */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 33 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 33 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 33 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 33 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* it telecom */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 36 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 36 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 36 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 36 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* it telecom */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 39 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 39 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 39 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 39 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* P A */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 42 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 42 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 42 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 42 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* front office */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 45 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 45 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 45 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 45 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* electronics enginnering */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 48 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 48 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 48 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 48 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* manage jobs */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 52 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 52 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 52 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 52 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* P A */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 55 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 55 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 55 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 55 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* Miscelleneous */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 58 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 58 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 58 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 58 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* P A */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 28 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 28 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 28 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 28 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* jbuild */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 31 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 31 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 31 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 31 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* retail */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 34 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 34 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 34 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 34 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* hardware */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 37 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 37 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 37 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 37 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* office admin */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 40 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 40 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 40 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 40 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* P A */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 43 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 43 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 43 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 43 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        /* P A */
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 46 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 46 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 46 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 46 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jlogistic(){
           $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 49 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 49 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 49 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 49 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jtelesale(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 53 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 53 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 53 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 53 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jgrad(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 56 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 56 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 56 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 56 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jfinancial(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 29 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 29 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 29 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 29 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jsalesmark(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 32 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 32 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 32 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 32 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jpurchasing(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 35 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 35 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 35 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 35 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jhealthcare(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 38 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 38 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 38 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 38 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jdriving(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 41 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 41 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 41 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 41 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jcatering(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 44 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 44 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 44 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 44 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jchemical(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 47 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 47 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 47 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 47 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jmechanical(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 50 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 50 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 50 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 50 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jdentists(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 51 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 51 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 51 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 51 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jpetrolem(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 54 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 54 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 54 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 54 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
        ...
        public function deals_pck_jnursing(){
            $bustype = $this->session->userdata('search_bustype');
                ...
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->join("urgent_details AS ud", "ud.ad_id=postad.ad_id AND ud.valid_to >= '".date("Y-m-d H:i:s")."'", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 57 AND urgent_package != '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 57 AND package_type = 3 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 57 AND package_type = 2 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
                ...
                $this->db->from('postad');
                $this->db->join("location as loc", "loc.ad_id = postad.ad_id", "left");
                $this->db->where("category_id = '1' AND sub_cat_id = 57 AND package_type = 1 AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$date'");
                if ($bustype) {
                    if ($bustype != 'all') {
                        $this->db->where("ad_type", $bustype);
                    }
