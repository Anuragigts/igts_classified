...
class Ads_model extends CI_Model{
	...
	function get_user_ListofAds($u_id){
		...
		function get_user_details($u_id){
			  ...
			  $this->db->select('l.user_type,l.login_id,l.bus_addr,l.bus_name,l.login_email,l.login_status,p.first_name,p.last_name,p.mobile');
	...
	function list_userads(){
		...
		$cats = $this->get_assigned_cats();
			$this->db->select('l.login_id, l.user_type, l.login_email,p.first_name,p.last_name,p.mobile,l.login_status, COUNT(p_ad.login_id) as pkg_count');
			//$this->db->where('p_ad.login_id',$u_id);
			//$this->db->join('pkg_duration_list as pkg_list','pkg_list.pkg_dur_id = p_ad.package_type','inner');
			//$this->db->join('catergory as cat','cat.category_id = p_ad.sub_cat_id','inner');
			$this->db->join("profile as p","l.login_id = p.login_id","inner");
			...
			/*$this->db->select('l.login_id, l.user_type, l.login_email,p.first_name,p.last_name,p.mobile,l.login_status, COUNT(p_ad.login_id) as pkg_count');
			//$this->db->select('l.login_id, l.user_type, l.login_email,p.first_name,p.last_name,p.mobile,l.login_status, p_ad.*');
			//$this->db->select();
