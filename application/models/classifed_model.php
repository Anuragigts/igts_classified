...
/*significant ads for ezone */
	...
	public function my_ads_user($data){
		$this->db->select("ad.ad_id,ad.deal_tag,pl.cost_pound, COUNT(`img`.`ad_id`) AS img_count,cat.category_name,pl.pkg_dur_name,ad.payment_status, a_s.status_name,u_lab.u_pkg__pound_cost,u_lab.u_pkg_name,u_lab.u_pkg_id");
		$this->db->join('ad_img as img', "img.ad_id = ad.ad_id", 'join');
		//$this->db->join('location as loc', "loc.ad_id = ad.ad_id", 'join');
