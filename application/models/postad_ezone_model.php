...
class Postad_ezone_model extends CI_Model{
       public function postad_creat(){
            ...
            /* Others Photography */
            public function busconcount_pothers(){
                $data = date("Y-m-d H:i:s");
                $this->db->select("(SELECT COUNT(*) FROM postad WHERE category_id = '8' AND sub_cat_id = 66 AND sub_scat_id = 498 AND ad_status = 1 AND expire_data >='$data' AND(ad_type = 'business' || ad_type = 'consumer')) AS allbustype,
                (SELECT COUNT(*) FROM postad WHERE category_id = '8' AND sub_cat_id = 66 AND sub_scat_id = 498 AND ad_status = 1 AND expire_data >='$data' AND ad_type = 'business') AS business,
                (SELECT COUNT(*) FROM postad WHERE category_id = '8' AND sub_cat_id = 66 AND sub_scat_id = 498 AND ad_status = 1 AND expire_data >='$data' AND ad_type = 'consumer') AS consumer");
                $rs = $this->db->get();
                return $rs->result();
            }
            public function sellerneeded_pothers(){
                $date = date("Y-m-d H:i:s");
                $this->db->select("(SELECT COUNT(*) FROM postad WHERE category_id = '8' AND sub_cat_id = 66 AND sub_scat_id = 498 AND services = 'Seller' AND ad_status = 1 AND expire_data >='$date') AS seller,
                (SELECT COUNT(*) FROM postad WHERE category_id = '8' AND sub_cat_id = 66 AND sub_scat_id = 498 AND services = 'Needed' AND ad_status = 1 AND expire_data >='$date') AS needed");
                $rs = $this->db->get();
                return $rs->result();
            }
            public function deals_pck_pothers(){
                $data = date("Y-m-d H:i:s");
                $this->db->select("(SELECT COUNT(ud.valid_to) AS aa FROM postad AS ad LEFT JOIN urgent_details AS ud ON ud.ad_id = ad.ad_id AND ud.valid_to >='$data'
                WHERE ad.category_id = '8' AND sub_cat_id = 66 AND sub_scat_id = 498 AND ad.urgent_package != '0' AND ad.ad_status = 1 AND ad.expire_data >= '$data') AS urgentcount,
                (SELECT COUNT(*) FROM postad WHERE category_id = '8' AND sub_cat_id = 66 AND sub_scat_id = 498 AND package_type = '6'  AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$data') AS platinumcount,
                (SELECT COUNT(*) FROM postad WHERE category_id = '8' AND sub_cat_id = 66 AND sub_scat_id = 498 AND package_type = '5'  AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$data') AS goldcount,
                (SELECT COUNT(*) FROM postad WHERE category_id = '8' AND sub_cat_id = 66 AND sub_scat_id = 498 AND package_type = '4'  AND urgent_package = '0' AND ad_status = 1 AND expire_data >='$data') AS freecount");
                $rs = $this->db->get();
                return $rs->result();
            }
            public function count_pothers_view(){
                $this->db->select("ad.*, img.*, COUNT(`img`.`ad_id`) AS img_count, loc.*, lg.*,ud.valid_to AS urg");
                $this->db->select("DATE_FORMAT(STR_TO_DATE(ad.created_on,
                '%d-%m-%Y %H:%i:%s'), '%Y-%m-%d %H:%i:%s') as dtime", FALSE);
                $this->db->from("postad AS ad");
                ...
                $this->db->where("ad.category_id", "8");
                $this->db->where("ad.sub_cat_id", "66");
                $this->db->where("ad.sub_scat_id", "498");
                $this->db->where("ad.ad_status", "1");
                $this->db->where("ad.expire_data >= ", date("Y-m-d H:i:s"));
                $this->db->group_by(" img.ad_id");
                $this->db->order_by('ad.approved_on', 'DESC');
            ...
            public function pothers_view($data){
                $this->db->select("ad.*, img.*, COUNT(`img`.`ad_id`) AS img_count, loc.*, lg.*,ud.valid_to AS urg");
                $this->db->select("DATE_FORMAT(STR_TO_DATE(ad.created_on,
                '%d-%m-%Y %H:%i:%s'), '%Y-%m-%d %H:%i:%s') as dtime", FALSE);
                $this->db->join("ad_img AS img", "img.ad_id = ad.ad_id", "join");
            ...
            public function count_pothers_search(){
                $search_bustype = $this->session->userdata('search_bustype');
                $dealurgent = $this->session->userdata('dealurgent');
                $dealtitle = $this->session->userdata('dealtitle');
                $dealprice = $this->session->userdata('dealprice');
            ...
            public function pothers_search($data){
                $search_bustype = $this->session->userdata('search_bustype');
                $dealurgent = $this->session->userdata('dealurgent');
                $dealtitle = $this->session->userdata('dealtitle');
                $dealprice = $this->session->userdata('dealprice');
