 ...
 */
class  H_ess_plant_gardenview extends CI_Controller{
        ...
        public function index(){
            ...
            $config = array();
            $config['base_url'] = base_url().'h_ess_plant_gardenview/index';
            $config['total_rows'] = count($this->postad_kitchen_model->count_hplant_search());
            $config['per_page'] = 30;
            ...
            $search_option = array(
                ...
                $kitchenhome_view = $this->postad_kitchen_model->hplant_search($search_option);
                ...
                $data   =   array(
                        "title"     =>  "Classifieds",
                        "content"   =>  "h_ess_plant_gardenview",
                ...
                $data['busconcount'] = $this->postad_kitchen_model->busconcount_hplants();
                 /*seller and needed count for kitchen*/
                $data['sellerneededcount'] = $this->postad_kitchen_model->sellerneeded_hplants();
                 /*packages count*/
                $data['deals_pck'] = $this->postad_kitchen_model->deals_pck_hplants();
         ...
         public function search_filters(){
            ...
            $config = array();
            $config['base_url'] = base_url().'h_ess_plant_gardenview/search_filters';
            $config['total_rows'] = count($this->postad_kitchen_model->count_hplant_search());
            $config['per_page'] = 30;
            $config['next_link'] = 'Next';
            $config['prev_link'] = 'Previous';
            ...
            /*location list*/
             ...
             $rs = $this->postad_kitchen_model->hplant_search($search_option);
             if (!empty($rs)) {
                foreach ($rs as $sview) {
            ...
            $result['favourite_list']=$favourite_list;
             /*business and consumer count for kitchen*/
                $result['busconcount'] = $this->postad_kitchen_model->busconcount_hplants();
                 /*seller and needed count for kitchen*/
                $result['sellerneededcount'] = $this->postad_kitchen_model->sellerneeded_hplants();
                 /*packages count*/
                $result['deals_pck'] = $this->postad_kitchen_model->deals_pck_hplants();
