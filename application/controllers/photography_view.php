 ...
 */
class  Photography_view extends CI_Controller{
        ...
        public function index(){
            ...
            $config = array();
            $config['base_url'] = base_url().'photography_view/index';
            $config['total_rows'] = count($this->classifed_model->count_poto_view());
            $config['per_page'] = 2;
            ...
            $search_option = array(
                ...
                $poto_result = $this->classifed_model->poto_view($search_option);
            ...
            $log_name = @mysql_result(mysql_query("SELECT first_name FROM `login` WHERE `login_id` = '$loginid'"), 0, 'first_name');
                ...
                $data['busconcount'] = $this->hotdealsearch_model->busconcount_poto();
                 /*seller and needed count for pets*/
                $data['sellerneededcount'] = $this->hotdealsearch_model->sellerneeded_poto();
                 /*packages count*/
                $data['deals_pck'] = $this->hotdealsearch_model->deals_pck_poto();
            ...
            $result['paging_links'] = $this->pagination->create_links();
              ...
              /*business and consumer count for pets*/
                $result['busconcount'] = $this->hotdealsearch_model->busconcount_poto();
                 /*seller and needed count for pets*/
                $result['sellerneededcount'] = $this->hotdealsearch_model->sellerneeded_poto();
                 /*packages count*/
                $result['deals_pck'] = $this->hotdealsearch_model->deals_pck_poto();
