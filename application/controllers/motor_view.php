 ...
 */
class  Motor_view extends CI_Controller{
        ...
        public function index(){
            ...
            $search_option = array(
                ...
                $motor_result = $this->classifed_model->motor_view($search_option);
            foreach ($motor_result as $pview) {
        ...
        public function search_filters(){
            ...
            /*location list*/
             $loc_list = $this->hotdealsearch_model->loc_list();
             $rs = $this->hotdealsearch_model->motors_search($search_option);
             if (!empty($rs)) {
                foreach ($rs as $sview) {
