                                ...
                                foreach($ad_reports as $list){?>
                                    <tr>
									   ...
									   <td><?php  
                                        ...
                                        echo $val;?></td>
                                       <!-- <td >
                                            <a class="btn btn-success " href="<?php echo base_url();?>admin/getAdReports/<?php echo $list->id.'/';?>" title="Activate the Reports " style=''><i class="halflings-icon ok-circle"></i> </a>
