							  ...
							  <div class="control-group">
								...
								<select id="user_type" name='user_type'>
								 ...
								 foreach($staff_types as $usertype){
									...
									<?php echo ucwords($usertype->user_type_name); ?></option>
								  <?php }
								  }?>
								  </select>
								</div>
							  ...
							  <div class="control-group">
								...
								<div class="controls">
								  <select id="staff_status" name='staff_status'>
									...
									<?php }?>
									<!--<option value='0' <?php if($staff->login_status == 0) echo 'selected';?>> <?php echo $staff->login_status; ?>In-Active</option>
									<option value='1' <?php if($staff->login_status == 1) echo 'selected';?>> <?php echo $staff->login_status; ?>Active</option>
									<option value='2' <?php if($staff->login_status == 2) echo 'selected';?>> <?php echo $staff->login_status; ?>On Hold</option>
									-->
								  </select>
								</div>
							  </div>
