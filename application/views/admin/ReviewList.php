                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX">
                               <td><?php echo ucwords($ads->deal_tag);?></td>
								...
								<!--<td>
									<a class="" href="<?php echo base_url();?>description_view/details/<?php echo $ads->id.'/';?>" target='_blank'title="View Ad Content" style=''>View</a>
								</td>-->
								...
								<!--<td>
									<a class="btn btn-success edit_postadd"  href="<?php echo base_url();?>" title="Ad Reviews Details">
