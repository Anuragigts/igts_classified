<div id="content" class="span9">
	...
	<br>
	<?php }
		// echo '<pre>';print_r($adwise_feedbacks[0]);echo '</pre>';?>
		...
		<div class="box span12">
			...
			<div class="box-content">
				<table class="table table-striped table-bordered bootstrap-datatable datatable">
					...
					<tbody>
						<?php $i = 0;
							foreach($adwise_feedbacks as $ads){$i++; ?>
						<tr class="odd gradeX">
							...
							<td>
								<a class="" href="<?php echo base_url();?>admin/getAdFeedbacks/<?php echo $ads->ad_id.'/';?>" title="View All Reports " style=''>View</a>
							</td>
						</tr>
						<?php } ?>
					</tbody>
