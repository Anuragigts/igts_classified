						...
						<fieldset>
							<div class="control-group span4">
								...
								<div class="controls">
									...
									<option value='<?php echo $pkgs->pkg_dur_id; ?>'><?php echo ucwords($pkgs->pkg_dur_name); ?></option>
									<?php }}?>
									</select>
								</div>
							</div>
							<div class="control-group span4">
								...
								<div class="controls">
									...
									<option value='<?php echo $cats->category_id; ?>'><?php echo ucwords($cats->category_name); ?></option>
									<?php }?>
									</select>
								</div>
							</div>
