...
$(function() {
    /*$(".newsletter").click(function() {
        var F = $("#name").val(),
            e = $("#email").val();
        if ("" == F) return $(".letter_name").show(), $(".letter_success").hide(), $(".letter_emailerr").hide(), $(".result").val(1), !1;
        if (("" != F) && F.length < 3) return $(".letter_min").show(),$(".letter_name").hide(), $(".letter_success").hide(), $(".letter_emailerr").hide(), $(".result").val(1), !1;
        // if ("" != F && ($(".letter_name").hide(), $(".letter_success").hide(), $(".letter_emailerr").hide(), $(".result").val(0)), "" == e) return $(".letter_email").show(), $(".letter_success").hide(), $(".letter_emailerr").hide(), $(".result").val(1), !1;
        if ("" != e) {
            var u = /^([a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+(\.[a-z\d!#$%&'*+\-\/=?^_`{|}~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+)*|"((([ \t]*\r\n)?[ \t]+)?([\x01-\x08\x0b\x0c\x0e-\x1f\x7f\x21\x23-\x5b\x5d-\x7e\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|\\[\x01-\x09\x0b\x0c\x0d-\x7f\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))*(([ \t]*\r\n)?[ \t]+)?")@(([a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[a-z\d\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.)+([a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]|[a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF][a-z\d\-._~\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]*[a-z\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])\.?$/i;
            u.test(e) ? ($(".letter_min").hide(),$(".letter_email").hide(), $(".letter_success").hide(), $(".letter_emailerr").hide(), $(".result").val(0)) : ($(".letter_min").hide(),$(".letter_email").show(), $(".letter_success").hide(), $(".letter_emailerr").hide(), $(".result").val(1))
        }
        0 == $(".result").val() && $.ajax({
            type: "POST",
            ...
            success: function(F) {
                0 == F ? ($(".letter_success").show(), $("#name").val(''), $("#email").val(''), setTimeout(function() {
                    $(".letter_success").hide()
                }, 5000), $(".letter_emailerr").hide()) : 1 == F && ($(".letter_emailerr").show(), $(".letter_success").hide())
            }
        })
    }), $("#name").keydown(function(F) {
        if (F.shiftKey || F.ctrlKey || F.altKey) F.preventDefault();
        else {
            var e = F.keyCode;
            8 == e || 32 == e || 46 == e || e >= 35 && 40 >= e || e >= 65 && 90 >= e || F.preventDefault()
        }
    })*/
	$(".newsletter").click(function(){
				var name = $("#name").val();
