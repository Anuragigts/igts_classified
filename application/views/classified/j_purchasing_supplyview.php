...
<title>Purchasing Jobs | Supply Services Jobs In UK | 99 Right Deals</title>

<meta name="description" content="Search latest ads for purchasing Jobs or supply services jobs in UK on 99 Right Deals. And get the quick respones for your dream jobs." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_purchasing_supplyview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget "> Purchasing & Supply</h4>
...
<?php echo $this->load->view("classified/j_purchasing_supplyview_search"); ?> 
</div>
</div>
</div>
</div>
