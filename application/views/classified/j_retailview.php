...
<title>Retail Jobs In London - United Kingdom | 99 Right Deals</title>

<meta name="description" content="Search current opening for reatils jobs in United Kingdom. Store manager, floor manager, supervisor, sales assistant openings are available in UK on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_retailview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Retail</h4>
...
<?php echo $this->load->view("classified/j_retailview_search"); ?> 
</div>
</div>
</div>
</div>
