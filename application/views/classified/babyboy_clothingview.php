...
<html>
	<head>
		...
		<title>Buy & Sell Used Baby Clothes For Sale In UK | 99 Right Deals</title>
		
		<meta name="description" content="Shop for new & used baby boys clothing for sale in United Kingdom. And find th new baby clothes for sale in UK on 99 Right Deals." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>babyboy_clothingview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white cloth_h3">
											...
											<h4 class="title-widget ">Baby Boy Clothing</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row clothstyle_result">
										   <?php echo $this->load->view("classified/babyboy_clothingview_search"); ?> 
										</div>
									</div>
								</div>
							</div>
