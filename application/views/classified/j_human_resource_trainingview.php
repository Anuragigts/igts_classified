...
<title>HR Jobs | Trainer Jobs In London - United Kingdom | 99 Roght Deals</title>

<meta name="description" content="Search current opening in HR & Trainer jobs in United Kingdom on 99 Right Deals. Find your dream jobs today in United Kingdom." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_human_resource_trainingview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget "> Human Resource & Training</h4>
...
<?php echo $this->load->view("classified/j_human_resource_trainingview_search"); ?> 
</div>
</div>
</div>
</div>
