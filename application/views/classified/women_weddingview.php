...
<title>Wedding Clothes, Sandals & Accessories For Sale In Uk | 99 Right Deals</title>

<meta name="description" content="Find ads for wedding clothes, sandals and accessories for sale in UK. Browes wedding stuff & items for sale in UK on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>women_weddingview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Women Wedding</h4>
...
<?php echo $this->load->view("classified/women_weddingview_search"); ?> 
</div>
</div>
</div>
</div>
