...
<meta name="DC.title" content="Classified Ads Website | Post Free Classified Ads In UK | 99 Right Deals" />
<meta name="geo.region" content="GB-LND" />
<meta name="geo.placename" content="London" />
<meta name="geo.position" content="51.495097;-0.273317" />
...
<img src="<?php echo base_url(); ?>img/marquee-120x60.png" class="fa fa-plane img-responsive" alt="hot deals uk" title="Hot Deals on 99 Right Deals">
</div>
...
<li class='descurl'><a href="<?php echo base_url(); ?>description_view/details/<?php echo $n_val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $n_val->deal_tag)); ?>" target="_self"><?php echo ucfirst($n_val->marquee); ?> </a></li>
<?php	}
}
else{
?>
...
<img class="img-responsive" src="img/featured/deals-250x150.jpg" alt="hot deals uk" title="Hot Deals Category">
<div class="overlay">
<h3>Hot Deals</h3>
...
<div class="hovereffect">
<img class="img-responsive" src="img/featured/ezone-250x150.jpg" alt="electronics in the uk " title="ezone Category">
<div class="overlay">
<h3>E-Zone</h3>
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 mob_pad_10">
<div class="hovereffect">
<img class="img-responsive" src="img/featured/cars-250x150.jpg" alt="buy and sell new and used cars" title="Motor Point Category">
<div class="overlay">
<h3>Motor Point</h3>
...
<div class="hovereffect">
<img class="img-responsive" src="img/featured/clothing-250x150.jpg" alt="buy and sell clothes online uk" title="Clothing & LifeStyles">
<div class="overlay">
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 mob_pad_10 desk_pad_10">
<div class="hovereffect">
<img class="img-responsive" src="img/featured/services-250x150.jpg" alt="free services ads" title="Services Category">
<div class="overlay">
<h3>Services</h3>
...
<div class="hovereffect">
<img class="img-responsive" src="img/featured/property-250x150.jpg" alt="residential or commercial property for sale" title="Find a Property Category">
<div class="overlay">
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 mob_pad_10 desk_pad_10">
<div class="hovereffect">
<img class="img-responsive" src="img/featured/kitchen-250x150.jpg" alt="home cleaning services" title="Home & Kitchen Category">
<div class="overlay">
<h3>Home & Kitchen</h3>
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 top_pad_10 desk_pad_10">
<div class="hovereffect">
<img class="img-responsive" src="img/featured/pets-250x150.jpg" alt="free online pet ads" title="Pets Category">
<div class="overlay">
<h3>Pets</h3>
...
<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6 mob_pad_10 desk_pad_10">
<div class="hovereffect">
<img class="img-responsive" src="img/featured/jobs-250x150.jpg"  alt="classified jobs ads" title="Jobs Category">
<div class="overlay">
<h3>Jobs</h3>
...
<?php 
if ($hot_deals_val->urgent_package != '0' && !is_null($hot_deals_val->urg)) {
?>
...
<div class="overlay descurl"><a href="description_view/details/<?php echo $hot_deals_val->adid; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $hot_deals_val->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
...
<?php } ?>
<a href="description_view/details/<?php echo $hot_deals_val->adid; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $hot_deals_val->deal_tag)); ?>" class="btn_v btn-3 btn-3d fa fa-arrow-right descurl"><span>View Details</span></a>
...
<div class="bus_logo">
<span></span><b><img data-u="image" src="<?php echo base_url(); ?>img/trader-130x50.png" alt='trader' title="Business Logo" /></b>
</div>
<div class="price11">
<span></span><b>
<img src="<?php echo base_url(); ?>img/icons/crown-35x35.png" class="pull-right" alt="Crown" title="Best Deal"></b>
...
<div class="overlay descurl"><a href="<?php echo base_url(); ?>description_view/details/<?php echo $val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $val->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
...
<h3 class="job_price"><?php echo "<span class='pound_sym'></span>".$jobmin."-<span class='pound_sym'></span>".$jobmax; ?></h3>
<?php } ?>
<a href="<?php echo base_url(); ?>description_view/details/<?php echo $val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $val->deal_tag)); ?>" class="btn_v btn-3 btn-3d fa fa-arrow-right descurl"><span>View Details</span></a>
<?php
...
<div class="overlay descurl"><a href="<?php echo base_url(); ?>description_view/details/<?php echo $m_ads->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $m_ads->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
<div class="info-gallery">
<h3><?php echo substr($m_ads->deal_tag,0,17); ?></h3>
<hr class="separator">
<h3 class="job_price"><?php echo "<span class='pound_sym'></span>".$jobmin."-<span class='pound_sym'></span>".$jobmax; ?></h3>
<a href="<?php echo base_url(); ?>description_view/details/<?php echo $m_ads->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $m_ads->deal_tag)); ?>" class="btn_v btn-3 btn-3d fa fa-arrow-right descurl"><span>View Details</span></a>
<?php
...
<div class="bus_logo">
<span></span><b><img data-u="image" src="<?php echo base_url(); ?>pictures/business_logos/trader-130x50.png" alt='trader' title="Business Logo" alt='Trader'/></b>
</div>
<?php } 
}
?>
...
<div class="overlay descurl"><a href="<?php echo base_url(); ?>description_view/details/<?php echo $m_ads_services->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $m_ads_services->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
<div class="info-gallery">
...
<a href="<?php echo base_url(); ?>description_view/details/<?php echo $m_ads_services->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $m_ads_services->deal_tag)); ?>" class="btn_v btn-3 btn-3d fa fa-arrow-right descurl"><span>View Details</span></a>
<?php
...
<div class="overlay descurl"><a href="<?php echo base_url(); ?>description_view/details/<?php echo $motor_val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $motor_val->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
<div class="info-gallery">
<h3><?php echo substr($motor_val->deal_tag,0,17); ?></h3>
<hr class="separator">
<h3 class="home_price"><?php echo $currency.number_format($motor_val->price); ?></h3>
<a href="<?php echo base_url(); ?>description_view/details/<?php echo $motor_val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $motor_val->deal_tag)); ?>" class="btn_v btn-3 btn-3d fa fa-arrow-right descurl"><span>View Details</span></a>
<?php
...
<div class="overlay descurl"><a href="<?php echo base_url(); ?>description_view/details/<?php echo $cloth_val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $cloth_val->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
<div class="info-gallery">
<h3><?php echo substr($cloth_val->deal_tag,0,17); ?></h3>
<hr class="separator">
<h3 class="home_price"><?php echo $currency.number_format($cloth_val->price); ?></h3>
<a href="<?php echo base_url(); ?>description_view/details/<?php echo $cloth_val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $cloth_val->deal_tag)); ?>" class="btn_v btn-3 btn-3d fa fa-arrow-right descurl"><span>View Details</span></a>
<?php
...
<div class="overlay descurl"><a href="<?php echo base_url(); ?>description_view/details/<?php echo $prop_val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $prop_val->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
<div class="info-gallery">
<h3><?php echo substr($prop_val->deal_tag,0,17); ?></h3>
<hr class="separator">
<h3 class="home_price"><?php echo $currency.number_format($prop_val->price); ?></h3>
<a href="<?php echo base_url(); ?>description_view/details/<?php echo $prop_val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $prop_val->deal_tag)); ?>" class="btn_v btn-3 btn-3d fa fa-arrow-right descurl"><span>View Details</span></a>
<?php
...
<div class="overlay descurl"><a href="<?php echo base_url(); ?>description_view/details/<?php echo $khome_val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $khome_val->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
<div class="info-gallery">
<h3><?php echo substr($khome_val->deal_tag,0,17); ?></h3>
<hr class="separator">
<h3 class="home_price"><?php echo $currency.number_format($khome_val->price); ?></h3>
<a href="<?php echo base_url(); ?>description_view/details/<?php echo $khome_val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $khome_val->deal_tag)); ?>" class="btn_v btn-3 btn-3d fa fa-arrow-right descurl"><span>View Details</span></a>
<?php
...
<div class="overlay descurl"><a href="<?php echo base_url(); ?>description_view/details/<?php echo $m_ads_pets->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $m_ads_pets->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
<div class="info-gallery">
<h3><?php echo substr($m_ads_pets->deal_tag,0,17); ?></h3>
<hr class="separator">
<h3 class="home_price"><?php echo $currency.number_format($m_ads_pets->price); ?></h3>
<a href="<?php echo base_url(); ?>description_view/details/<?php echo $m_ads_pets->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $m_ads_pets->deal_tag)); ?>" class="btn_v btn-3 btn-3d fa fa-arrow-right descurl"><span>View Details</span></a>
<?php
...
<div class="overlay descurl"><a href="<?php echo base_url(); ?>description_view/details/<?php echo $m_ads_ezone->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $m_ads_ezone->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
<div class="info-gallery">
<h3><?php echo substr($m_ads_ezone->deal_tag,0,17); ?></h3>
<hr class="separator">
<h3 class="home_price"><?php echo $currency.number_format($m_ads_ezone->price); ?></h3>
<a href="<?php echo base_url(); ?>description_view/details/<?php echo $m_ads_ezone->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $m_ads_ezone->deal_tag)); ?>" class="btn_v btn-3 btn-3d fa fa-arrow-right descurl"><span>View Details</span></a>
<?php
...
<div class="overlay descurl"><a href="description_view/details/<?php echo $b_ads->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $b_ads->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
...
<div class="bus_logo"><span></span><b><img data-u="image" src="<?php echo base_url(); ?>pictures/business_logos/trader-130x50.png" alt='trader' title="Business Logo" /></b></div>
<?php	} 	}
?>
<?php if ($b_ads->package_type == 2 || $b_ads->package_type == 5) { ?>
...
<img src="img/business_deals-262x388.jpg" alt="buy and sell online" title="Business Deals" class="recentad_heig img-responsive">
</a>
</div>
...
<img src="img/recentad- 262x388.jpg" alt="local classifieds ads" title="Recent Deals" class="recentad_heig img-responsive">
</a>
</div>
<div class="col-sm-9 col-xs-12">
...
<div class="overlay descurl"><a href="description_view/details/<?php echo $free_val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $free_val->deal_tag)); ?>" ><i class="fa fa-link"></i></a></div>
</div>
...
<h3 class="job_price"><?php echo "<span class='pound_sym'></span>".$jobmin."-<span class='pound_sym'></span>".$jobmax; ?></h3>
<?php } ?>
<a href="description_view/details/<?php echo $free_val->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $free_val->deal_tag)); ?>" class="btn_v btn-3 btn-3d fa fa-arrow-right descurl"><span>View Details</span></a>
<div class="price">
<?php if ($free_val->package_type == 3 || $free_val->package_type == 6) { ?>
<span></span><b><img src="<?php echo base_url(); ?>img/icons/crown-35x35.png" alt="crown" title="Best Deal"></b>
<?php	} ?>
<?php if ($free_val->package_type == 2 || $free_val->package_type == 5) { ?>
...
<script>
$(function(){$(".ticker1").modernTicker({effect:"scroll",scrollType:"continuous",scrollStart:"inside",scrollInterval:20,transitionTime:500,autoplay:true});$(".ticker2").modernTicker({effect:"fade",displayTime:4e3,transitionTime:300,autoplay:true});$(".ticker3").modernTicker({effect:"type",typeInterval:10,displayTime:4e3,transitionTime:300,autoplay:true});$(".ticker4").modernTicker({effect:"slide",slideDistance:100,displayTime:4e3,transitionTime:350,autoplay:true})})
</script>

<script src="<?php echo base_url(); ?>js/box-slider-all.jquery.min.js"></script>

<script>
$(function(){$("#buss_logo_home").css("display","none")}),$(function(){var e=function(e,t,o,i){l.stop().css("width",0),n.removeClass("current").eq(i).addClass("current")},t=function(){l.animate({width:"100%"},s)},o=$("#box"),n=$(".goto-slide"),i=$(".effect"),l=$("#time-indicator"),s=5e3,r={speed:1200,autoScroll:!0,timeout:s,next:"#next",prev:"#prev",pause:"#pause",onbefore:e,onafter:t},d={blindLeft:{blindCount:15},blindDown:{blindCount:15},tile3d:{tileRows:6,rowOffset:80},tile:{tileRows:6,rowOffset:80}};o.boxSlider(r),t(),$("#controls").on("click",".goto-slide",function(e){o.boxSlider("showSlide",$(this).data("slideindex")),e.preventDefault()}),$("#effect-list").on("click",".effect",function(n){var l=$(this),s=l.data("fx"),f=d[s];i.removeClass("current"),l.addClass("current"),e(null,null,0,0),o.boxSlider("destroy").boxSlider($.extend({effect:s},r,f)),t(),n.preventDefault()})});
</script>

<script type="text/javascript">
$(function(){$(".fdk_ad").click(function(){$("#fdbkads").val($(this).attr("id"))})});
</script>

<script src="<?php echo base_url(); ?>j-folder/js/jquery.validate.min.js"></script>

<script>
$(document).ready(function(){$("#list-autocomplete").autocomplete({source:"<?php echo base_url(); ?>classified/search_autocomplete",minLength:1,messages:{noResults:"No Data Found"}}),$("#looking_search").autocomplete({source:"<?php echo base_url(); ?>classified/search_dealtag",minLength:1,messages:{noResults:"No Data Found"}})});
</script>

<script type="text/javascript">
jQuery(document).ready(function(){jQuery(".tp-banner").show().revolution({dottedOverlay:"none",delay:5e3,startwidth:1170,startheight:925,minHeight:500,navigationType:"none",navigationArrows:"solo",navigationStyle:"preview1"})}); 
</script>
