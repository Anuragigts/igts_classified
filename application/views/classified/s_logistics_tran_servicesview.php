...
<title>Logistics Services | Transport Services In UK | 99 Right Deals</title>

<meta name="description" content="Find the latest online free ads for logistics and transport services in United Kingdom on 99 Right Deals. Place free ads for verious services in London, United Kingdom." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_logistics_tran_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Logistics & Transport</h4>
...
<?php echo $this->load->view("classified/s_logistics_tran_servicesview_search"); ?> 
</div>
