...
<title>Telemarketing Jobs In London, Birmingham, UK | 99 Right Deals</title>

<meta name="description" content="Find free online ads for telemarkeing jobs or tele servicing jobs in United Kingdom. Place your own ads for tele jobs on 99 Roght Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_telesalesview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Telesales</h4>
...
<?php echo $this->load->view("classified/j_telesalesview_search"); ?> 
</div>
</div>
</div>
</div>
