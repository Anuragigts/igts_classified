...
<title>Embroidery Services In London UK | 99 Right Deals</title>

<meta name="description" content="Find the embroidery services in United Kingdom at affordable price on 99 Right Deals. And place an ads for expert embroidery worker in London." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_embroidery_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Embroidery Services</h4>
...
<?php echo $this->load->view("classified/s_embroidery_servicesview_search"); ?> 
</div>
