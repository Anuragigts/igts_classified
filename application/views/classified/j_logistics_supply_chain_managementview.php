...
<html>
	<head>
		...
		<title>Supply Chain Management Jobs In UK | 99 Right Deals</title>
		
		<meta name="description" content="Find the  current opening for logistics & supply chain management in United Kingdom on 99 Right Deals. Search your dream jobs today in Operational industry." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>j_logistics_supply_chain_managementview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget">Logistics & Supply Chain Management</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches jobs_search_result">
											<?php echo $this->load->view("classified/j_logistics_supply_chain_managementview_search"); ?> 
										</div>
									</div>
								</div>
							</div>
