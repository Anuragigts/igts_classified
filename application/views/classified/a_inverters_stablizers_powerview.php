...
<html>
	<head>
		...
		<title>New & Used Inverters & Stablizers For Sale In UK | 99 Right Deals</title>
		
		<meta name="description" content="Find used Inverters or Stablizer for Sale in United Kingdom. Buy or Sell online variety of inverters or stablizer for sale on 99 Right Deals." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>a_inverters_stablizers_powerview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget ">Inverters,Stablizers & Power</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches motor_result">
											<?php echo $this->load->view("classified/a_inverters_stablizers_powerview_search"); ?>
										</div>
									</div>
								</div>
							</div>
