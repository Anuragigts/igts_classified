...
<title>New & Used Garden Tools or Equipment For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Shop for new & used garden tool & equipment for sale in UK. Garden fork, garden hose, hedge trimmer and many more tools or equipment find on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>h_ess_garden_equipmentview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Garden Equipment</h4>
...
<?php echo $this->load->view("classified/h_ess_garden_equipmentview_search"); ?>
</div>
</div>
</div>
</div>
