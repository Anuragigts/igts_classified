...
<title>Doctor and Hospital Services In UK | London -  99 Right Deals</title>

<meta name="description" content="Find your specialist Doctor and Hospital Services in UK or London on 99 Right Deals. And get the appointment instantly and also find free ads for doctor services or hospital services." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_doctor_hospital_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Doctors & hospital services</h4>
...
<?php echo $this->load->view("classified/s_doctor_hospital_servicesview_search"); ?> 
</div>
