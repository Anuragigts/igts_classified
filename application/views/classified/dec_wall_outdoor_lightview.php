...
<html>
	<head>
		...
		<title>Buy Used Wall Light | Outdoor Light  For Sale In UK | 99 Right Deals</title>
		
		<meta name="description" content="Find for internal or external décor, buy used wall light and outdoor light for sale in United Kingdom on 99 Right Deals." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>dec_wall_outdoor_lightview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white cloth_h3">
											...
											<h4 class="title-widget ">Wall & Outdoor Lights</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches kitchen_search_result">
											<?php echo $this->load->view("classified/dec_wall_outdoor_lightview_search"); ?>
										</div>
									</div>
								</div>
							</div>
