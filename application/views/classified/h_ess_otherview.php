...
<title>New & Used Home Items For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Shop for online buy & sell used home & kitchen items for sale in United Kingdom at affordable prices on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>h_ess_otherview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<?php echo $this->load->view("classified/h_ess_otherview_search"); ?>
</div>
</div>
</div>
</div>
