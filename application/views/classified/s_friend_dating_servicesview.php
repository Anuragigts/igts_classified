...
<title>Friendship Services | Dating Services In UK | 99 Right Deals</title>

<meta name="description" content="Find the local classifieds ads for making online friends and dating services in United Kingdom on 99 Right Deals. And making fun or enjoy with new friends or partner." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_friend_dating_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Friendship & Dating</h4>
...
<?php echo $this->load->view("classified/s_friend_dating_servicesview_search"); ?> 
</div>
