		...
		<style>
			...
			@media screen and (min-device-width: 320px) and (max-device-width: 480px) {
				...
				.tp-caption.large_bold_white {
					...
					top: 62.649px !important;
				}
				.tp-caption.small_light_white {
					font-size: 12px !important;
					top: 65.649px !important;
				}
			}
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<section class="content_info top_20 hidden-lg hidden-md hidden-sm">
					<form action="<?php echo base_url(); ?>searchview" method="get" autocomplete="off">
						<div class="container">
							<div class="row">
								<div class="col-md-10 col-sm-10 col-xs-10 col-md-offset-1 col-sm-offset-1 col-xs-offset-1 search_menu j-forms">
				...
				<section class="content_info">
					<div class="">
						<div class="container">
							<div class="row">
								<div class="col-md-8 col-sm-12 col-xs-12 hidden-lg hidden-md hidden-sm">
									<div class="titles">
									...
									<div class="row">
										<div class="col-md-4 col-sm-4 col-xs-4">
											<div>
												<a href="hot-deals-post-classifieds-ads">
													<img class="img-responsive" src="img/featured/deals.png" alt="hot deals uk" title="Hot Deals Category">
												</a>
											</div>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-4">
											<div>
												<a href="e-zone-phones-tablets-sale">
													<img class="img-responsive" src="img/featured/ezone.png" alt="electronics in the uk " title="ezone Category">
												</a>
											</div>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-4">
											<div>
												<a href="motor-point-used-cars-sale">
													<img class="img-responsive" src="img/featured/cars.png" alt="buy and sell new and used cars" title="Motor Point Category">
												</a>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-4 col-sm-4 col-xs-4">
											<div>
												<a href="clothes-for-sale-uk">
													<img class="img-responsive" src="img/featured/clothing.png" alt="buy and sell clothes online uk" title="Clothing & LifeStyles">
												</a>
											</div>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-4">
											<div>
												<a href="household-services-london-uk">
													<img class="img-responsive" src="img/featured/services.png" alt="free services ads" title="Services Category">
												</a>
											</div>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-4">
											<div>
												<a href="residential-commercial-property-for-sale">
													<img class="img-responsive" src="img/featured/property.png" alt="residential or commercial property for sale" title="Find a Property Category">
												</a>
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-4 col-sm-4 col-xs-4">
											<div>
												<a href="home-kitchen-services-uk">
													<img class="img-responsive" src="img/featured/kitchen.png" alt="home cleaning services" title="Home & Kitchen Category">
												</a>
											</div>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-4">
											<div>
												<a href="pet-for-sale-online">
													<img class="img-responsive" src="img/featured/pets.png" alt="free online pet ads" title="Pets Category">
												</a>
											</div>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-4">
											<div>
												<a href="part-full-time-jobs-london">
													<img class="img-responsive" src="img/featured/jobs.png"  alt="classified jobs ads" title="Jobs Category">
												</a>
											</div>
										</div>
									</div>
								...
								<div class="col-md-4 col-sm-4 col-xs-12 hidden-lg hidden-md hidden-sm">
									<div class="">
										...
										<div id="boxes-carousel-hot">
										
											<?php 
											if (!empty($hot_deals)) {
												foreach ($hot_deals as $free_val) {
													/*currency symbol*/ 
					...
					<div class="padding-bottom">
						...
						<div class="container">
							<div class="row">
								<div class="col-sm-3 col-xs-12">
									<a href="#">
									<img src="img/recentad.jpg" alt="local classifieds ads" title="Recent Deals" class="recentad_heig img img-responsive">
									</a>
								</div>
								<div class="col-sm-9 col-xs-12">
