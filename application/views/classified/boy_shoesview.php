...
<html>
	<head>
		...
		<title>New & Used Boys Shoes For Sale | Buy & Sell Shoes In UK | 99 Right Deals</title>
		
		<meta name="description" content="Find classifieds ads for new & used boys shoes for sale in UK. Browse wide range of Buy & Sell used shoes for sale on 99 Right Deals." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>boy_shoesview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white cloth_h3">
											...
											<h4 class="title-widget ">Boy Shoes</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row clothstyle_result">
										   <?php echo $this->load->view("classified/boy_shoesview_search"); ?> 
										</div>
									</div>
								</div>
							</div>
