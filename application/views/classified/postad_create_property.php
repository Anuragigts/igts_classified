...
<title>Post a Deal Find A Property | 99 Right Deals</title>
...
<form action="<?php echo base_url(); ?>postad_create_property" method="post" class="j-forms j-multistep tooltip-hover" id="j-forms" enctype="multipart/form-data" novalidate>
<div class="header">
...
<ul class="social-team pull-left">
<li><a href="" data-toggle="modal" data-target="#Property" ><b>Change Category</b></a></li>
</ul>
</div>
</div>
</div>
...
<div class="input">
<label class="icon-right" for="Position">
<img src="<?php echo base_url(); ?>j-folder/img/position.png" alt="Position" title="Position">
</label>
...
<img src="<?php echo base_url(); ?>j-folder/img/property.png" alt="Property" title="Property Icon">
</label>
...
<img src="<?php echo base_url(); ?>j-folder/img/property.png" alt="Floor number" title="Floor number">
</label>
...
<!-- Modal -->
<form method='post' id='edit_property_form' action="<?php echo base_url(); ?>postad_create_property">
