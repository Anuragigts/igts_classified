...
<title>Other Services Manchester | Services In London, UK | 99 Right Deals</title>

<meta name="description" content="Find the thousands of other services in United Kingdom on 99 Right Deals. And get the verious services like motor, laundry, hospital and many more." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_other_popular_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Others Popular</h4>
...
<?php echo $this->load->view("classified/s_other_popular_servicesview_search"); ?> 
</div>
