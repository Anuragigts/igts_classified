...
<title>Front Office Jobs | Help Desk Jobs In UK | 99 Right Deals</title>

<meta name="description" content="Serach online ads for front office and help desk jobs in United Kingdom on 99 Right Deals. Get an opportunity to make career in office assitance, receptionist and so on." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_front_office_help_deskview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Front Office & Help Desk</h4>
...
<?php echo $this->load->view("classified/j_front_office_help_deskview_search"); ?> 
</div>
</div>
</div>
</div>
