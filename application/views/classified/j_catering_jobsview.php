...
<title>Wedding, Party Catering Jobs In London - UK | 99 Right Deals</title>

<meta name="description" content="Find the wide range of catering jobs in United Kingdom. Search thousands of catering jobs for wedding, party, hotal, home based on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_catering_jobsview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget "> Catering Jobs</h4>
...
<?php echo $this->load->view("classified/j_catering_jobsview_search"); ?> 
</div>
</div>
</div>
</div>
