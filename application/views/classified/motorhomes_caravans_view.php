	...
	<section class="content-central">
		...
		<form id="j-forms2" action="<?php echo base_url(); ?>motorhomes_caravans_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
						...
						<div class="row">
							...
							<div class="col-md-9">
								...
								<div class="row list_view_searches cars_result">
                                    <?php echo $this->load->view("classified/motorhomes_caravans_view_search"); ?>
								</div>
							</div>
						</div>
					</div>
