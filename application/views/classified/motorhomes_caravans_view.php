	<title>99 Right Deals :: Motor-Home & Caravans View</title>
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="container-by-widget-filter bg-dark color-white">
									<!-- Widget Filter -->
									<h3 class="title-widget">Motorhome Filter</h3>
									...
									<div class="cd-filter-block">
										<h4 class="title-widget closed">Berth</h4>
										<div class="cd-filter-content" style="overflow: hidden; display: none;">
											<div id="limit_scrol">
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
                                        ...
                                        <div class="col-md-3">
                                            <ul class="style-view">
                                                ...
                                                <li data-toggle="tooltip" title="" data-original-title="LIST VIEW" class="active">
                                                    <a href="motorhomes_caravans_view">
