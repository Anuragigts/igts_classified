...
<div class="row">
<div class="col-xs-12">
<p class=""><?php echo substr(strip_tags($m_details->deal_desc), 0, 72); ?></p>
</div>
<div class="col-xs-7">
...
<li><i class="fa fa-clock-o"></i><span><?php echo date("M d, Y H:i:s", strtotime($m_details->updated_on)); ?></span></li>
...
<div class="overlay descurl"><a href="<?php echo base_url(); ?>description_view/details/<?php echo $m_details->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $m_details->deal_tag)); ?>"><i class="top_20 fa fa-link"></i></a></div>
</div>
<div class="">
<div class="price11">
<span></span><b>
