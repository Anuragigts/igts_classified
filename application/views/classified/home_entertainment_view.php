...
<title>New & Used Home Entertainment Items For Sale In London, UK | 99 Right Deals</title>

<meta name="description" content="Find the home entertainment items like TV's, home theater, gaming and projectors  for sale in United Kingdom on 99 Right Deals at affordable price." />
...
$entertain_sub12 = $this->session->userdata('entertain_sub');
...
<form id="j-forms2" action="<?php echo base_url(); ?>home_entertainment_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<?php echo $this->load->view("classified/home_entertainment_view_search"); ?>
</div>
</div>
</div>
</div>
