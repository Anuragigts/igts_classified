...
<form id="j-forms2" action="<?php echo base_url(); ?>sa_cookers_steamersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Cookers & Steamers</h4> 
