	<title>99 Right Deals :: Motor View</title>
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="container-by-widget-filter bg-dark color-white">
									<!-- Widget Filter -->
									<h3 class="title-widget">Motors Filter</h3>
										...
										<div class="cd-filter-content">
											<div class="filters_categories">	
												<ul class="list-styles">
													<li><i class="fa fa-arrow-circle-o-right"></i><a href="cars_view"> Cars</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i><a href="bikes_scoters_view"> Bikes & Scoters</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i><a href="motorhomes_caravans_view"> Motorhomes & Caravans</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i><a href="vans_trunks_svu_view"> Vans,Trunks & SUV's</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i><a href="coaches_busses_view"> Coaches & Busses</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i><a href="plantmachinery_view"> Plant Machinery</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i><a href="farmingvehicles_view"> Farming Vehicles</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i><a href="boats_view"> Boats</a></li>
												</ul>
												</ul>
											</div>
										</div>
