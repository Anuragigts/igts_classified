	...
	<section class="content-central">
		...
		<form id="j-forms2" action="<?php echo base_url(); ?>motor_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
						...
						<div class="row">
										...
										<div class="cd-filter-content">
											<div class="filters_categories">	
												<ul class="list-styles">
													<?php foreach ($motor_sub as $motor_sub1) {
														$carcnt = $motor_sub1->car;
														$bikescnt = $motor_sub1->bikes;
														$motorhomescnt = $motor_sub1->motorhomes;
														$vanscnt = $motor_sub1->vans;
														$busescnt = $motor_sub1->buses;
							...
							<div class="col-md-9 col-sm-9">
								...
								<div class="row list_view_searches motor_result">
									<?php echo $this->load->view("classified/motor_view_search"); ?>
								</div>
							</div>
						</div>
					</div>
