...
<html>
	<head>
		...
		<title>New & Used Cable & Connetors For Sale In UK | 99 Right Deals</title>
		
		<meta name="description" content="Used Cable & Connectors for Sale in United Kingdom on 99 Right Deals at nominal price. Find free ads for cable & connectors  in UK." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>lc_cables_connectorsview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget ">Cables & Connectors</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches motor_result">
											<?php echo $this->load->view("classified/lc_cables_connectorsview_search"); ?>
										</div>
									</div>
								</div>
							</div>
