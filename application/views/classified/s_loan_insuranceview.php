...
<html>
	<head>
		...
		<title>Loan & Insurance Services In United Kingdom | 99 Right Deals</title>
		
		<meta name="description" content="See the Latest ads related to loan & insurance services like Educational,Home, Cars, Property, Gold or Life & Retirement insurance in London, UK On 99 Right Deals." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_loan_insuranceview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget ">Loan & insurance</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row search_result">
										  <?php echo $this->load->view("classified/s_loan_insuranceview_search"); ?> 
										</div>
