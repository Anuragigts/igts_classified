				...
				<div class="container">
					<div class="row">
						<div class="wrapper wrapper-640" style="padding-top: 0px;">
							<form action="#" method="post" class="j-forms j-multistep" id="j-forms" enctype="multipart/form-data" novalidate>
								<div class="header">
									<p>Post a Deal</p>
								</div>
								<!--end /.header-->
												...
												<div class="span6">
													...
													<div class="j-row">
														...
														<div class="span5 unit top_20">
															<div class="input">
																<label class="icon-right" for="dealtag">
																<img src="j-folder/img/price.png" alt="price" title="price view">
																</label>
