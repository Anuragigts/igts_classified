...
<div class="col-xs-12">
<a href="#" data-toggle="modal" data-target="#sendnow" <?php echo $sval->ad_id; ?> <?php echo $sval->ad_id; ?> class="send_now_show btn_v btn-4 btn-4a fa fa-arrow-right top_4"><span>Send Now</span></a>
</div>
</div>
</div>
</div>
