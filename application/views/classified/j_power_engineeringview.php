...
<title>Power Engineer Jobs In London - UK | 99 Right Deals</title>

<meta name="description" content="Find the current opening for engineering jobs in power industry or sector in United Kingdom. See the latest ads related to engineering jobs on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_power_engineeringview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Power Engineering</h4>
...
<?php echo $this->load->view("classified/j_power_engineeringview_search"); ?> 
</div>
</div>
</div>
</div>
