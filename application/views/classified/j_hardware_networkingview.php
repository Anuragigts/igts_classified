...
<title>Computer Hardware Jobs | Networking Jobs In UK | 99 Right Deals</title>

<meta name="description" content="Find current opening for hardware & networking jobs in United Kingdom. See the latest Network administrator,helpdesk support,network support openings in UK." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_hardware_networkingview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Hardware & Networking</h4>
...
<?php echo $this->load->view("classified/j_hardware_networkingview_search"); ?> 
</div>
</div>
</div>
</div>
