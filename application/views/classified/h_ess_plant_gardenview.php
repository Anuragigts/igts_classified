...
<html>
	<head>
		...
		<title>Garden Plants For Sale In UK | Garden Plants Services | 99 Right Deals</title>
		
		<meta name="description" content="Find online ads for garden plants for sale in United Kingdom. Search online classifieds ads for garden plants care services in UK on 99 Right Deals" />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>h_ess_plant_gardenview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white cloth_h3">
											...
											<h4 class="title-widget">Plants @ Garden</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches kitchen_search_result">
											<?php echo $this->load->view("classified/h_ess_plant_gardenview_search"); ?>
										</div>
									</div>
								</div>
							</div>
