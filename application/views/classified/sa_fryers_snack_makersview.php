...
<title>New & Used Fryers | Snack Makers For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Find ads for buy or sell fryers & snack makers in United Kingdom on 99 Right Deals. And get tons of services awaiting for you." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>sa_fryers_snack_makersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Fryers & Snack makers</h4> 
...
<?php echo $this->load->view("classified/sa_fryers_snack_makersview_search"); ?>
</div>
</div>
</div>
</div>
