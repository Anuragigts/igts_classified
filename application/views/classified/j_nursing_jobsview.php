...
<title>Nursing Jobs In London - United Kingdom | 99 Right Deals</title>

<meta name="description" content="Serach for thousands of nursing jobs or care home jobs in United Kingdom on 99 Right Deals. Apply online today and get quick respones for dream jobs." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_nursing_jobsview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget "> Nursing Jobs</h4>
...
<?php echo $this->load->view("classified/j_nursing_jobsview_search"); ?> 
</div>
</div>
</div>
</div>
