...
<html>
	<head>
		...
		<?php foreach ($busconcount as $countval) {
		  ...
		  foreach ($men_list_count as $men_list_countval) {
			$cloths = $men_list_countval->clothes;
			$shoes = $men_list_countval->shoes;
							...
							<div class="container">
								<div class="row">
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches mens_result">
											<?php echo $this->load->view("classified/men_view_search"); ?> 
										</div>
										<div class='row'>
											<div class='col-md-12'>
