										...
										<div class="cd-filter-content">
											<div class="filters_categories">	
												<ul class="list-styles">
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="professional_view" class="active_filter">Professional </a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="popular_view">Popular </a></li>
												</ul>
											</div>
										</div>
									</div> 
