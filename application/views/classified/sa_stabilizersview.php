...
<form id="j-forms2" action="<?php echo base_url(); ?>sa_stabilizersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Stabilizers</h4> 
...
<?php echo $this->load->view("classified/sa_stabilizersview_search"); ?>
</div>
</div>
</div>
</div>
