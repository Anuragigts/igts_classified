...
<title>Significant Deals In London - United Kingdom | 99 Right Deals</title>
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>significant_deals_view/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<!-- Widget Filter -->
<a href="<?php echo base_url(); ?>view-all-significant-deals"><h3 class="title-widget">Significant Deals</h3></a>
<div class="cd-filter-block">
<div class="cd-filter-content">
<div class="filters_categories">	
<ul class="list-styles">
<li><i class="fa fa-arrow-circle-o-right"></i><a href="<?php echo base_url(); ?>view-all-mostvalued-deals"> Most Valued Deals</a></li>
...
<?php echo $this->load->view("classified/significant_deals_view_search"); ?> 
</div>
