...
<title>Buy & Sell Vases With Flowers For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Shop for vintage, new & used vases and flowers for sale in United Kingdom at best price on 99 Right deals. Post online ads for buy & sell vases with flowers in UK." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>dec_vases_flowersview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Vases & Flowers</h4>
...
<?php echo $this->load->view("classified/dec_vases_flowersview_search"); ?>
</div>
</div>
</div>
</div>
