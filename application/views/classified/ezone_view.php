						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="container-by-widget-filter bg-dark color-white">
									<!-- Widget Filter -->
									<h3 class="title-widget">E-Zone Filter </h3>
									
									<div class="cd-filter-block">
										<h4 class="title-widget">All Types</h4>
										<div class="cd-filter-content">
											<div class="filters_categories">	
												<ul class="list-styles">
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="phones_tablets_view">Phones & Tablets</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="home_applications_view">Home Appliances</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="small_applicaances_view">Small Appliances</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="laptop_computers_view">Laptop & Computers</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="accessories_view">Accessories</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="personal_care_view">Personal Care</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="home_entertainment_view">Home Entertainment</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="photography_view">Photography</a></li>
												</ul>
											</div>
										</div>
									</div>
