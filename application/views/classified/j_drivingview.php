...
<html>
	<head>
		...
		<title>Part Time Driving | Full Time Driving Jobs In UK | 99 Right Deals</title>
		
		<meta name="description" content="Find Ads for full time/part time driving jobs in UK on 99 Right Deals. And also search for cab driving, texi driving jobs in United Kingdom." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>j_drivingview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget "> Driving</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches jobs_search_result">
											<?php echo $this->load->view("classified/j_drivingview_search"); ?> 
										</div>
									</div>
								</div>
							</div>
