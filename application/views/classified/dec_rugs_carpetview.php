...
<form id="j-forms2" action="<?php echo base_url(); ?>dec_rugs_carpetview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Rugs & Carpets</h4>
...
<?php echo $this->load->view("classified/dec_rugs_carpetview_search"); ?>
</div>
</div>
</div>
</div>
