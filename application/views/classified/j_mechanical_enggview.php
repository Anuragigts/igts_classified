...
<title>Mechanical Engineering | Engineering Jobs In UK | 99 Right Deals</title>

<meta name="description" content="Get online jobs for Mechanical Engineering jobs in United Kingdom on 99 Right Deals. Find the wide range of engineering jobs in UK." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_mechanical_enggview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget "> Mechanical Engineering</h4>
...
<?php echo $this->load->view("classified/j_mechanical_enggview_search"); ?> 
</div>
</div>
</div>
</div>
