	...
	<script type="text/javascript">
		$(document).ready(
			...
			$farming_sub1 = $this->session->userdata('farming_sub');  
	...
	<section class="content-central">
		...
		<form id="j-forms2" action="<?php echo base_url(); ?>farmingvehicles_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-3">
								<div class="container-by-widget-filter bg-dark color-white">
									<!-- Widget Filter -->
									<a href="<?php echo base_url(); ?>motor_view"><h3 class="title-widget">Motors Filter</h3></a>
									
									<div class="cd-filter-block">
										<h4 class="title-widget">Farming vehicles</h4>
										<div class="cd-filter-content">
											<div id="limit_scrol">
												<?php foreach ($farming_sub as $farming_subval) { ?>
												<label class="checkbox">
													<input type="checkbox" name="farming_sub[]" class='farming_sub' value="<?php echo $farming_subval->sub_subcategory_id; ?>" <?php if(isset($farming_sub1) && in_array($farming_subval->sub_subcategory_id,$farming_sub1)){ echo 'checked = checked'; } ?> >
													<i></i> <?php echo $farming_subval->sub_subcategory_name; ?> (<?php echo $farming_subval->no_ads; ?>)
												</label>
												<?php } ?>
											</div>
										</div>
							...
							<div class="col-md-9 col-sm-9">
								...
								<div class="row list_view_searches motor_result">
									<?php echo $this->load->view("classified/farmingvehicles_view_search"); ?>
								</div>
							</div>
						</div>
					</div>
