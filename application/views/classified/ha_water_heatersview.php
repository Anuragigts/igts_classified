...
<html>
	<head>
		...
		<title>New & Used Water Heaters For Sale In UK | 99 Right Deals</title>
		
		<meta name="description" content="Find latest free ads for water heaters in Uk on 99 Right Deals. And start buy or sell used water heaters in London or United Kingdom." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>ha_water_heatersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget">Water Heaters</h4> 
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches motor_result">
											<?php echo $this->load->view("classified/ha_water_heatersview_search"); ?>
										</div>
									</div>
								</div>
							</div>
