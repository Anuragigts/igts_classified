								...
								<div class="container-by-widget-filter bg-dark color-white">
									...
									<div class="cd-filter-block">
										...
										<div class="cd-filter-content">
											<div id="limit_scrol">
												<?php foreach ($boats_sub as $boats_subval) { ?>
												<label class="checkbox">
													<input type="checkbox" name="boats_sub[]" class='boats_sub' value="<?php echo $boats_subval->sub_subcategory_id; ?>" <?php if(isset($boats_sub12) && in_array($boats_subval->sub_subcategory_id,$boats_sub12)) echo 'checked = checked';?> >
													<i></i> <?php echo $boats_subval->sub_subcategory_name; ?> (<?php echo $boats_subval->no_ads; ?>)
												</label>
												<?php } ?>
											</div>
										</div>
