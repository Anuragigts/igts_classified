...
<html>
	<head>
		...
		<title>New & Used Living Room Furniture For Sale In UK | 99 Right Deals</title>
		
		<meta name="description" content="Shop online for living room & bedroom furniture for sale in United Kingdom on 99 Right Deals. Also buy used home & kitchen furniture for sale in UK." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>h_ess_living_room_furview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches kitchen_search_result">
											<?php echo $this->load->view("classified/h_ess_living_room_furview_search"); ?>
										</div>
									</div>
								</div>
							</div>
