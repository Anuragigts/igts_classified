...
<title>New & Used Girls Shoes For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Buy & Sell used girls shoes for sale in UK. Get free classifieds ads for new & used girls shoes for sale like sandals,formal, casual, boots, high heels on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>girl_shoesview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Girls Shoes</h4>
...
<?php echo $this->load->view("classified/girl_shoesview_search"); ?> 
</div>
</div>
</div>
</div>
