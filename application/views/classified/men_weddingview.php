...
<title>Mens Wedding Clothes, Shoes & Accessories For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Search online free ads for wedding clothes & accessories for sale in UK. And find wedding stuff & accessories for sale In UK on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>men_weddingview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Men Wedding</h4>
...
<?php echo $this->load->view("classified/men_weddingview_search"); ?> 
</div>
</div>
</div>
</div>
