...
<title>Used Sewing Machine For Sale | Buy And Sell Sewing Machines | 99 Right Deals</title>

<meta name="description" content="Post online free ads for used sewing machine for sale in United Kingdom on 99 Right Deals. Find ads for buy and sell sewing machines." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>ha_sewing_machineview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Sewing Machine</h4> 
...
<?php echo $this->load->view("classified/ha_sewing_machineview_search"); ?>
</div>
</div>
</div>
</div>
