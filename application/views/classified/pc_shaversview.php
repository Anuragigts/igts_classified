...
<title>Buy & Sell Used Shavers For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Search free classifieds ads for shaver for sale online in United Kingdom on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>pc_shaversview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Shavers</h4>
...
<?php echo $this->load->view("classified/pc_shaversview_search"); ?>
</div>
</div>
</div>
</div>
