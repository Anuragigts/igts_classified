...
<form id="j-forms2"action="<?php echo base_url(); ?>bikes_scoters_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Bikes Scooter Filter</h4>
<div class="cd-filter-content">
<div id='limit_scrol'>
<?php foreach ($motor_sub as $motor_subval) { ?>
<label class="checkbox">
<input type="checkbox" name="bikes_sub[]" class="bikes_sub" value="<?php echo $motor_subval->sub_subcategory_id; ?>" <?php if (in_array($motor_subval->sub_subcategory_id,$bikes_sub)) { echo "checked = checked";	} ?> >
...
<?php echo $this->load->view("classified/bikes_scoters_view_search"); ?>
</div>
</div>
</div>
</div>
