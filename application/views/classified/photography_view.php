...
<title>New & Second Hand Digital Camera For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Buy & Sell Used and New photography digital camera for sale in London, UK at best price on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>photography_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<?php echo $this->load->view("classified/photography_view_search"); ?>
</div>
</div>
</div>
</div>
