...
<title>Funreal Services In London, United Kingdom | 99 Right Deals</title>

<meta name="description" content="Find the Funeral Services in London or United Kingdom. Create free ads for cremation services on 99 Right Deals." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_funeral_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Funeral services</h4>
...
<?php echo $this->load->view("classified/s_funeral_servicesview_search"); ?> 
</div>
