...
<form id="j-forms2" action="<?php echo base_url(); ?>a_batteryview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Battery</h4>
...
<?php echo $this->load->view("classified/a_batteryview_search"); ?>
</div>
</div>
</div>
</div>
