										...
										<div class="cd-filter-content">
											<div class="filters_categories">	
												<ul class="list-styles">
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="women_view">Women</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="men_view">Men </a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="boys_view">Boy</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="girls_view">Girls</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="baby_boy_view">Baby Boy</a></li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="baby_girl_view">Baby Girl</a></li>
												</ul>
											</div>
										</div>
									</div>
                                        ...
                                        <div class="col-md-3">
                                            <ul class="style-view">
                                                ...
                                                <li data-toggle="tooltip" title="" data-original-title="LIST VIEW" class="active">
                                                    <a href="clothing_lifestyles_view">
