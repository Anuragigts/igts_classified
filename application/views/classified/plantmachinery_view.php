	<title>99 Right Deals :: Plant Machinery View</title>
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="container-by-widget-filter bg-dark color-white">
									<!-- Widget Filter -->
									<h3 class="title-widget">Plant Machinery</h3>
										...
										<div class="cd-filter-content">
											<div>
												<label class="checkbox">
													...
													<i></i> Farming Machinery 
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Forklift Attachments
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Forklifts
									...
									<div class="cd-filter-block">
										<h4 class="title-widget closed">Registration year</h4>
										<div class="cd-filter-content" style="overflow: hidden; display: none;">
											<div id="limit_scrol">
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
