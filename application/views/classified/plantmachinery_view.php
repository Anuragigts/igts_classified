...
$plants_sub12 = $this->session->userdata('plants_sub');
...
<img src="img/img-theme/shp-1090x457.png" class="img-responsive" alt="Shadow" title="Shadow view">
</div>
<form id="j-forms2" action="<?php echo base_url(); ?>plantmachinery_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<div id="limit_scrol">
<?php foreach ($plants_sub as $plants_subval) { ?>
<label class="checkbox">
<input type="checkbox" name="plants_sub[]" class='plants_sub' value="<?php echo $plants_subval->sub_subcategory_id; ?>" <?php if(isset($plants_sub12) && in_array($plants_subval->sub_subcategory_id,$plants_sub12)){ echo 'checked = checked'; } ?> >
<i></i> <?php echo $plants_subval->sub_subcategory_name; ?> (<?php echo $plants_subval->no_ads; ?>)
</label>
<?php } ?>
</div>
</div>
...
<?php echo $this->load->view("classified/plantmachinery_view_search"); ?>
</div>
</div>
</div>
</div>
