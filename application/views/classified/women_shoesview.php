...
<title>Ladies Shoes For Sale | Buy & Sell Women Footware In UK | 99 Right Deals</title>

<meta name="description" content="Shop For new & used women shoes for sale in UK. Find clssifieds ads for women footware, sports shoes, boots, ladies shoes for sale in UK on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>women_shoesview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Womens Shoes</h4>
...
<?php echo $this->load->view("classified/women_shoesview_search"); ?> 
</div>
</div>
</div>
</div>
