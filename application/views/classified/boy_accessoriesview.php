...
<title>New & Used Boys Accessories For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Browse new & used boys accessories for sale in UK at affordable price. And get the quick respone for stuff & accessories for sale in UK on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>boy_accessoriesview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Boy Accessories</h4>
...
<?php echo $this->load->view("classified/boy_accessoriesview_search"); ?> 
</div>
</div>
</div>
</div>
