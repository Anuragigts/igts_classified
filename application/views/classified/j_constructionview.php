...
<title>Construction Jobs In London - United Kingdom | 99 Right Deals</title>

<meta name="description" content="Search for current opening in construction jobs in United Kingdom. Get the verious positions are available in United Kingdom on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_constructionview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Construction</h4>
...
<?php echo $this->load->view("classified/j_constructionview_search"); ?> 
</div>
</div>
</div>
</div>
