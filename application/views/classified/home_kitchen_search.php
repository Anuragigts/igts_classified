	<title>365 Deals :: Home & Kitchen search</title>
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="container-by-widget-filter bg-dark color-white">
									<!-- Widget Filter -->
									<h3 class="title-widget">Home & Kitchen</h3>
									<div class="cd-filter-block">
										<h4 class="title-widget">Appliance Type</h4>
										<div class="cd-filter-content">
											<div id="limit_scrol">
												...
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Electric Cookers
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Electric Kettles
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Food Processors
												...
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Micro Wave Ovens
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Oven Toaster Griller
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Pop Up Toasters
									...
									<div class="cd-filter-block">
										<h4 class="title-widget"> Brand Name</h4>
										<div class="cd-filter-content">
											<div id="limit_scrol">
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
