...
<form id="j-forms2" action="<?php echo base_url(); ?>lc_softwaresview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<?php echo $this->load->view("classified/lc_softwaresview_search"); ?>
</div>
</div>
</div>
</div>
