...
<html>
	<head>
		...
		<title>Pen Drives For Sale | Buy, Sell Pen Drives In UK | 99 Right Deals</title>
		
		<meta name="description" content="Buy or Sell pen drives in United Kingdom. And get free classifieds ads for pen drives for sale on 99 Right Deals at affordable price." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>lc_pen_drivesview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget ">Pen Drives</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches motor_result">
											<?php echo $this->load->view("classified/lc_pen_drivesview_search"); ?>
										</div>
									</div>
								</div>
							</div>
