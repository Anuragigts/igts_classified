...
<html>
	<head>
		...
		<title>Commercial Property for Sale | Commercial Property For Rent | 99 Right Deals</title>
		
		<meta name="description" content="Find the commercial property for sale in United Kingdom at affordable price on 99 Right Deals. And also find commercial property for rent, commercial land for sale in UK." />
		<meta name="keywords" content="commercial property for rent, commercial real estate for sale, industrial property for sale, commercial land for sale, commercial property search, commercial building for sale, commercial real estate for rent, business properties for sale, commercial property sale, commercial property to buy, real estate business for sale, real estate commercial property, commercial houses for sale" />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>residential_com/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches residential_result">
											<?php echo $this->load->view('classified/residential_com_search') ?>
										</div>
									</div>
								</div>
							</div>
