...
<title>Recent Deals In London - United Kingdom | 99 Right Deals</title>
...
<!-- Widget Filter -->
<a href="<?php echo base_url(); ?>view-all-recent-deals"><h3 class="title-widget">Recent Deals</h3></a>
...
<?php echo $this->load->view("classified/recent_deals_view_search"); ?> 
</div>
