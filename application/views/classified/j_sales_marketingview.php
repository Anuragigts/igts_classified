...
<title>Sales Jobs | Marketing Jobs In London - UK | 99 Right Deals</title>

<meta name="description" content="Find the current opening for sales & marketing jobs in United Kingdom. See the latest wide range of sales & marketing jobs ads on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_sales_marketingview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget "> Sales & Marketing</h4>
...
<?php echo $this->load->view("classified/j_sales_marketingview_search"); ?> 
</div>
</div>
</div>
</div>
