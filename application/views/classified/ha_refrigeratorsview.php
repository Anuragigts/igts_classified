...
<title>Second Hand & Used Refigerator For Sale In UK | 99 Right Deals</title>

<meta name="description" content="We offer free ads for buy and sell fans in United Kingdom . And enhanced your own business with the help of 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>ha_refrigeratorsview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Refrigerators</h4>  
...
<?php echo $this->load->view("classified/ha_refrigeratorsview_search"); ?>
</div>
</div>
</div>
</div>
