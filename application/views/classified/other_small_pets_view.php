...
<form id="j-forms2" action="<?php echo base_url(); ?>other_small_pets_view/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Other Small Pets Filter</h4>
