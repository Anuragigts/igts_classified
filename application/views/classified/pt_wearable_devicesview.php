...
<title>Used Wearable Devices For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Find online free ads for wearable devices for sale in united kingdom on 99 Right Deals. See the latest ads of wearable devices." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>pt_wearable_devicesview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Wearable Devices</h4>
...
<?php echo $this->load->view("classified/pt_wearable_devicesview_search"); ?>
</div>
</div>
</div>
</div>
