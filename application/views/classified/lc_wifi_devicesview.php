...
<title>New & Used Wi-Fi Devices For Sale In UK | 99 Right Deals</title>

<meta name="description" content="99 Right Deals is offering free ads for new or used Wi-Fi devices for sale in United Kingdom. And create own business online classifieds ads. " />
...
<form id="j-forms2" action="<?php echo base_url(); ?>lc_wifi_devicesview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Wi-Fi Devices</h4>
...
<?php echo $this->load->view("classified/lc_wifi_devicesview_search"); ?>
</div>
</div>
</div>
</div>
