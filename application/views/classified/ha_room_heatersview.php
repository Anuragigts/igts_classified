...
<title>New & Used Room Heaters For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Find tons of classifieds ads for new and used or second hand room heaters for sale in United Kingdom on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>ha_room_heatersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Room Heaters</h4> 
...
<?php echo $this->load->view("classified/ha_room_heatersview_search"); ?>
</div>
</div>
</div>
</div>
