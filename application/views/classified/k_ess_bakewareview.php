...
<form id="j-forms2" action="<?php echo base_url(); ?>k_ess_bakewareview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Bakeware</h4>
...
<?php echo $this->load->view("classified/k_ess_bakewareview_search"); ?>
</div>
</div>
</div>
</div>
