...
<html>
	<head>
		...
		<title>Beef Cattle For Sale In UK | 99 Right Deals</title>
		
		<meta name="description" content="99 Right Deals provides free classified ads for beef cattles for sale in United Kingdom" />
		<meta name="keywords" content="beef cattle for sale, beef cattle for sale in uk,buy beef cattle,buy beef cattle online,buy sell beef cattle" />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>beef_cattle_view/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget">Beef Filter</h4>
