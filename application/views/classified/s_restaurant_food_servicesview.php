...
<title>Food Services | Restaurant Services In UK | 99 Right Deals</title>

<meta name="description" content="Find the classifieds ads for food and restaurant services in United Kingdom on 99 Right Deals. And get the food services at office or home at affordable prices." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_restaurant_food_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Restaurant & Food</h4>
...
<?php echo $this->load->view("classified/s_restaurant_food_servicesview_search"); ?> 
</div>
