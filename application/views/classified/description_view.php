...
<style>
.section-title-01{height:220px;background-color:#262626;text-align:center;position:relative;width:100%;overflow:hidden}.j-forms{box-shadow:none!important}.add-to-compare-list{position:absolute;left:auto}
.add-to-compare-list span.favourite_label1 {
background: url(<?php echo base_url(); ?>img/icons/favinactive.png);
width: 31px;height: 31px;display: block;cursor: pointer;}
.add-to-compare-list span.favourite_label1.active {
background: url(<?php echo base_url(); ?>img/icons/favactive.png);
width: 31px;height: 31px;display: block;cursor: pointer !important;}
.jgallery[data-jgallery-id="1"] .jgallery-thumbnails a{width:100px!important;height:60px}.jgallery{height:480px!important}.owl-item{width:283px!important}.nav-bottom .fade{display:none}
</style>
...
<script>
$(function(){$("#rating_form").validate({rules:{review_title:{required:!0,minlength:5,maxlength:25},review_msg:{required:!0,minlength:12,maxlength:60},review_name:{required:!0},user_rating:{required:!0}},messages:{review_title:{required:"Please Enter review title",minlength:"Title contains atleast 5 characters",maxlength:"Title contains maximum 25 characters"},review_msg:{required:"Please Enter review message",minlength:"Title contains atleast 12 characters",maxlength:"Title contains maximum 60 characters"},review_name:{required:"Please Enter review name"},user_rating:{required:"Please give review rating"}},submitHandler:function(e){return!0}}),$("#send_now_desc").validate({rules:{fbkcontname:{required:!0},feedbackmsg:{required:!0,minlength:60},busemail:{required:!0,email:!0},feedbackno:{required:!0}},messages:{fbkcontname:{required:"Please Enter contact name"},feedbackmsg:{required:"Please Enter feedback message",minlength:"message contains atleast 60 characters"},busemail:{required:"Please Enter valid mail id"},feedbackno:{required:"Please Enter Mobile Number"}},submitHandler:function(e){return!0}}),$("#reportforads").validate({rules:{reportmsg:{required:!0,minlength:60}},messages:{reportmsg:{required:"Please Enter feedback message",minlength:"message contains atleast 60 characters"}},submitHandler:function(e){return!0}})});
</script>
...
<script type="text/javascript">
$(document).ready(function(){$("#parentHorizontalTab").easyResponsiveTabs({type:"default",width:"auto",fit:!0,closed:"accordion",tabidentify:"hor_1",activate:function(t){var e=$(this),a=$("#nested-tabInfo"),i=$("span",a);i.text(e.text()),a.show()}}),$("#ChildVerticalTab_1").easyResponsiveTabs({type:"vertical",width:"auto",fit:!0,tabidentify:"ver_1",activetab_bg:"#fff",inactive_bg:"#F5F5F5",active_border_color:"#c1c1c1",active_content_border_color:"#5AB1D0"})});
</script>

<script>
setTimeout(function(){$(".alert").hide()},5e3);
</script>
