		...
		<script type="text/javascript">
			$(document).ready(
				function()
				{
				 ...
				 $phone_sub12 = $this->session->userdata('phone_sub');
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>phones_tablets_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
