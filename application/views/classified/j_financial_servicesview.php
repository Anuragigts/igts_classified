...
<title>Financial Jobs In London - UK | 99 Right Deals</title>

<meta name="description" content="Thousands are financial jobs awaiting for you in United Kingdom on 99 Right Deals. Huge range of financial jobs are available in United Kingdom." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_financial_servicesview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget "> Financial Services</h4>
...
<?php echo $this->load->view("classified/j_financial_servicesview_search"); ?> 
</div>
</div>
</div>
</div>
