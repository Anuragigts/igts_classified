...
<form id="j-forms2" action="<?php echo base_url(); ?>dec_photo_frames_albumview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Photo frames & Albums</h4>
...
<?php echo $this->load->view("classified/dec_photo_frames_albumview_search"); ?>
</div>
</div>
</div>
</div>
