...
<title>Electronics & Engineering Jobs In London - UK | 99 Right Deals</title>

<meta name="description" content="Search ads for engineering jobs in London, United kingdom. Find your dream jobs today in electronics, electrical, civil engineering on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_electronics_electrical_ngineeringview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Electronics & Electrical Engineering</h4>
...
<?php echo $this->load->view("classified/j_electronics_electrical_ngineeringview_search"); ?> 
</div>
</div>
</div>
</div>
