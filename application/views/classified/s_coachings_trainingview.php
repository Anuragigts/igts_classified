...
<title>Coaching Services London | Training Services In UK | 99 Right Deals</title>

<meta name="description" content="See the tons of Coaching & Training Services in London or United Kingdom on 99 Right Deals likes educational, musical, GYM training, sports, dance tarining or coaching." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_coachings_trainingview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Coachings & Training</h4>
...
<?php echo $this->load->view("classified/s_coachings_trainingview_search"); ?> 
</div>
