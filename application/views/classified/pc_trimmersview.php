...
<title>Buy & Sell Used Trimmers For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Search online free ads for trimmer for sale in United Kingdom. Find variety of trimmers awaiting for you at affordable price on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>pc_trimmersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Trimmers</h4>
...
<?php echo $this->load->view("classified/pc_trimmersview_search"); ?>
</div>
</div>
</div>
</div>
