...
<title>Used Stylish & Designer Mens Clothes For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Shop for new & used mens clothes for sale in UK. Find the stylish & designer clothes for  sale in UK on 99 Right Deals at affordable price." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>men_clothingview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Men Clothing</h4>
...
<?php echo $this->load->view("classified/men_clothingview_search"); ?> 
</div>
</div>
</div>
</div>
