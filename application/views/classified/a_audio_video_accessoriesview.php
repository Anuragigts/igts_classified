...
<form id="j-forms2" action="<?php echo base_url(); ?>a_audio_video_accessoriesview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<?php echo $this->load->view("classified/a_audio_video_accessoriesview_search"); ?>
</div>
</div>
</div>
</div>
