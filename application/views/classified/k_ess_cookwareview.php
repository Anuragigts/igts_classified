...
<title>Used Cookware | Buy & Sell Cookware For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Find the recent ads for new & used cookware for sale in UK. Buy & Sell cookware's wide range like pots, pans, fry pans, non-stick pan and many more on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>k_ess_cookwareview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Cookware</h4>
...
<?php echo $this->load->view("classified/k_ess_cookwareview_search"); ?>
</div>
</div>
</div>
</div>
