...
<title>New & Used Girls Clothes For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Find ads for stylish & designer girls clothes for sale in UK. And also create ads for new & used girls clothes for sale online on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>girl_clothingview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Girls Clothing</h4>
...
<?php echo $this->load->view("classified/girl_clothingview_search"); ?> 
</div>
</div>
</div>
</div>
