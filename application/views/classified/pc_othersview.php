...
<form id="j-forms2" action="<?php echo base_url(); ?>pc_othersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<?php echo $this->load->view("classified/pc_othersview_search"); ?>
</div>
</div>
</div>
</div>
