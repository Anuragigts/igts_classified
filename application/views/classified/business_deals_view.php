...
<title>Business Deals In London - United Kingdom | 99 Right Deals</title>
...
<a href="<?php echo base_url(); ?>view-all-business-deals"><h3 class="title-widget">Business Deals</h3></a>
...
<?php echo $this->load->view("classified/business_deals_view_search"); ?> 
</div>
