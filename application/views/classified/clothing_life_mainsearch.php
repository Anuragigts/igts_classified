												...
												<ul class="list-styles">
													...
													<li id="motor_fil_show"><i class="fa fa-arrow-circle-o-right"></i> Motor Point
														<ul class="filters_left" id="motor_fil_hide" style="display:none;">
															<li><i class="fa fa-angle-right"></i> <a href="">Cars</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Bikes & Scoters</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Motorhomes & Caravans</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Vans,Trunks & SUV's</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Coaches & Busses</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Plant Machinery</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Farming Vehicles</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Boats</a></li>
														</ul>
													</li>
													<li id="clot_fil_show"><i class="fa fa-arrow-circle-o-right"></i> Clothing & LifeStyles
														<ul class="filters_left" id="clot_fil_hide" style="display:none;">
															<li><i class="fa fa-angle-right"></i> <a href="">Women</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Men </a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Boy</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Girls</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Baby Boy</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Baby Girl</a></li>
														</ul>
													</li>
													<li id="service_fil_show"><i class="fa fa-arrow-circle-o-right"></i> Services
														<ul class="filters_left" id="service_fil_hide" style="display:none;">
															...
															<li><i class="fa fa-angle-right"></i> <a href="">Popular </a></li>
														</ul>
													</li>
													<li id="property_fil_show"><i class="fa fa-arrow-circle-o-right"></i> Find a Property
														<ul class="filters_left" id="property_fil_hide" style="display:none;">
															<li><i class="fa fa-angle-right"></i> <a href="">Residential</a></li>
													...
													<li id="home_fil_show"><i class="fa fa-arrow-circle-o-right"></i> Home & Kitchen
														<ul class="filters_left" id="home_fil_hide" style="display:none;">
															<li><i class="fa fa-angle-right"></i> <a href="">Kitchen Essentials</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Home Essentials </a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Decor </a></li>
														</ul>
													</li>
													<li id="pets_fil_show"><i class="fa fa-arrow-circle-o-right"></i> Pets
														<ul class="filters_left" id="pets_fil_hide" style="display:none;">
															<li><i class="fa fa-angle-right"></i> <a href="">Dogs</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Cats</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Fishes</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Birds</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Big Animals</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Small Animals</a></li>
															<li><i class="fa fa-angle-right"></i> <a href="">Pet Accessories </a></li>
														</ul>
													</li>
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="">Jobs</a></li>
												</ul>
											</div>
										</div>
									</div>
