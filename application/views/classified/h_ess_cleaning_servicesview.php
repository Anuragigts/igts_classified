...
<form id="j-forms2" action="<?php echo base_url(); ?>h_ess_cleaning_servicesview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Cleaning Services</h4>
...
<?php echo $this->load->view("classified/h_ess_cleaning_servicesview_search"); ?>
</div>
</div>
</div>
</div>
