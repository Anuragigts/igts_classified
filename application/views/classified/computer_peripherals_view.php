...
<title>Printer | Hard Disk | Pen Drive | Keyboard | Cables & Connectors For Sale | 99 Right Deals </title>

<meta name="description" content="Shop all the computer peripherals devices for sale in United Kingdom at the affordable price on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>computer_peripherals_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<?php echo $this->load->view("classified/computer_peripherals_view_search"); ?>
</div>
</div>
</div>
</div>
