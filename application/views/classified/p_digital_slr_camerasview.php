...
<html>
	<head>
		...
		<title>SLR For Sale | Digital Cameras Sale | 99 Right Deals</title>
		
		<meta name="description" content="Buying and Selling on the internet SLR for sale in UK. And find the free ads for sell your camera, buying DSLR camera, DSLR photography, sell my digital cemera and many more." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>p_digital_slr_camerasview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget ">Digital SLR Cameras</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches motor_result">
											<?php echo $this->load->view("classified/p_digital_slr_camerasview_search"); ?>
										</div>
									</div>
								</div>
							</div>
