...
<html>
	<head>
		...
		<title>Sheep For Sale | Pet Lambs For Sale | 99 Right Deals</title>
		
		<meta name="description" content="Find the sheeps for sale in United Kingdom with 99 Right Deals. Post free ads for lambs for sale, buy sheep online, sheep sales in UK." />
		<meta name="keywords" content="sheep for sale, sheep sales, sheep for sale uk, pet lambs for sale, pet sheep for sale, buying sheep online, baby lambs for sale uk, miniature sheep for sale uk" />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>sheeps_view/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget">Sheep Filter</h4>
