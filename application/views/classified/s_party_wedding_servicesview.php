...
<title>Party Services | Wedding Services In UK | 99 Right Deals</title>

<meta name="description" content="Don't worried about for party or wedding services in UK. 99 Right Deals having tons of wedding services like DJ, Photography, cameraman, catering, decoration and so on." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_party_wedding_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Party & wedding services</h4>
...
<?php echo $this->load->view("classified/s_party_wedding_servicesview_search"); ?> 
</div>
