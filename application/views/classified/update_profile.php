...
<script>
function isNumber(e){e=e?e:window.event;var n=e.which?e.which:e.keyCode;return n>31&&(48>n||n>57)?!1:!0}$(function(){$("#save_changes").validate({rules:{firstnamepost:{required:!0,lettersonly:!0,minlength:3,maxlength:12},lastnamepost:{required:!0,lettersonly:!0,minlength:3,maxlength:12},contactnopost:{required:!0,minlength:11}},messages:{firstnamepost:{required:"Please enter first name",minlength:'Please Enter minimuum 3 characters',maxlength:'Maximum 12 characters allowed'},lastnamepost:{required:"Please enter last name",minlength:'Please Enter minimuum 3 characters',maxlength:'Maximum 12 characters allowed'},contactnopost:{required:"Please enter a mobile no",minlength:'Please enter 11 digit number'}},submitHandler:function(e){return!0}})}),$(function(){$.validator.addMethod("pwcheck",function(e){return/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).+$/.test(e)}),$("#change_pwd").validate({rules:{currentpasspost:{required:!0},newpasspost:{required:!0,minlength:8,pwcheck:!0},confirmpasspost:{required:!0,minlength:8,equalTo:"#newpasspost",pwcheck:!0}},messages:{currentpasspost:{required:"Please enter a current password"},newpasspost:{required:"Please enter a new password",pwcheck:"Should Include atleast one lowercase, one uppercase, one digit"},confirmpasspost:{required:"Please enter a confirm password",pwcheck:"Should Include atleast one lowercase, one uppercase, one digit"}},submitHandler:function(e){return!0}})});
