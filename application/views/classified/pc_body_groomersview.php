...
<form id="j-forms2" action="<?php echo base_url(); ?>pc_body_groomersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Body Groomers</h4>
...
<?php echo $this->load->view("classified/pc_body_groomersview_search"); ?>
</div>
</div>
</div>
</div>
