...
<html>
	<head>
		...
		<title>Point & Shoot Cameras, Best Digital Camera Point And Shoot - 99 Right Deals</title>
		
		<meta name="description" content="Classifieds site for Point & Shoot Cameras for Sale in UK on 99 Right Deals. Best digital camera point and shoot, point and shoot film cameras, best point and click cameras." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>p_point_shoot_camerasview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget ">Point & Shoot Cameras</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches motor_result">
											<?php echo $this->load->view("classified/p_point_shoot_camerasview_search"); ?>
										</div>
									</div>
								</div>
							</div>
