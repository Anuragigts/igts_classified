...
<title>Graduate Jobs | Find Graduate Jobs In UK | 99 Right Deals</title>

<meta name="description" content="Are you looking for graduate jobs, fresher jobs, experience jobs in United Kingdom. Find huge current opening jobs ads on 99 Right Deals" />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_graduate_jobsview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Graduate Jobs</h4>
...
<?php echo $this->load->view("classified/j_graduate_jobsview_search"); ?> 
</div>
</div>
</div>
</div>
