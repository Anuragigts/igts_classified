...
<form id="j-forms2" action="<?php echo base_url(); ?>dec_cushion_throwview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Cushions & Throws</h4>
...
<?php echo $this->load->view("classified/dec_cushion_throwview_search"); ?>
</div>
</div>
</div>
</div>
