...
<title>Buy & Sell Used Projectors For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Search variety of projector for sale in United Kingdom. And find free ads for New or Used Projector for sale on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>he_projectorsview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Projectors</h4>
...
<?php echo $this->load->view("classified/he_projectorsview_search"); ?>
</div>
</div>
</div>
</div>
