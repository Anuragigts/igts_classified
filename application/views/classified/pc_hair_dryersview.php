...
<title>New & Used Hair Dryers For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Post online advertisement ads for new or used hair dryer for sale in United Kingdom. Ang get the change to create own free ads online on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>pc_hair_dryersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<a href="<?php echo base_url(); ?>body-care-stuff-for-sale"><h4 class="title-widget">Personal Care</h4></a>
<h4 class="title-widget ">Hair Dryers</h4>
...
<?php echo $this->load->view("classified/pc_hair_dryersview_search"); ?>
</div>
</div>
</div>
</div>
