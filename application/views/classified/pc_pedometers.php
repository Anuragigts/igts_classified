...
<title>New & Used Pedometers For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Find free advertisement website for creating online ads for used Pedometer for sale in United Kingdom on 99 Right deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>pc_pedometers/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Pedometers</h4>
...
<?php echo $this->load->view("classified/pc_pedometers_search"); ?>
</div>
</div>
</div>
</div>
