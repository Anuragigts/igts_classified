...
<title>Buy & Sell Used Mens Accessories For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Shop for buy & sell used mens accessories for sale in United Kingdom. Find new & used mens accessories for sale like wallets, watches, bags on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>men_accessoriesview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Men Accessories</h4>
...
<?php echo $this->load->view("classified/men_accessoriesview_search"); ?> 
</div>
</div>
</div>
</div>
