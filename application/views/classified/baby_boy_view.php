...
$sub_cat = $this->session->userdata('babyboy_list');
...
<form id="j-forms2" action="<?php echo base_url(); ?>baby_boy_view/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
