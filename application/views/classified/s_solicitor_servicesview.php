...
<html>
	<head>
		...
		<title>Solicitor Services In London, UK - 99 Right Deals</title>
		
		<meta name="description" content="Are you looking for solicitor services in United Kingdom? Get ready for expertise solicitor services on 99 Right Deals" />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_solicitor_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget ">Solicitor services</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row search_result">
										  <?php echo $this->load->view("classified/s_solicitor_servicesview_search"); ?> 
										</div>
