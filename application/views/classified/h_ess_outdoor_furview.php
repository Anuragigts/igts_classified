...
<title>Outdoor Furniture | Patio | Garden Furniture For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Shop for new & used outdoor furniture, patio furniture, garden furniture for sale in United Kingdom at best price on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>h_ess_outdoor_furview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Outdoor Furniture</h4>
...
<?php echo $this->load->view("classified/h_ess_outdoor_furview_search"); ?>
</div>
</div>
</div>
</div>
