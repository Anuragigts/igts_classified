...
<li><i class="fa fa-arrow-circle-o-right"></i><a href="<?php echo base_url(); ?>baby-girl-clothing"> Clothing (<?php echo $cloths; ?>)</a></li>
<li><i class="fa fa-arrow-circle-o-right"></i><a href="<?php echo base_url(); ?>baby-girl-accessories"> Accessories (<?php echo $accessories; ?>)</a></li>
</ul>
</div>
</div>
</div>
