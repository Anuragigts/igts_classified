	...
	<?php foreach ($busconcount as $countval) {
	  ...
	  foreach ($babygirl_list_count as $babygirl_list_countval) {
	  	$cloths = $babygirl_list_countval->clothes;
	  	$accessories = $babygirl_list_countval->accessories;
	  }
	  		$sub_cat = $this->session->userdata('babygirl_list');
	...
	<section class="content-central">
		...
		<form id="j-forms2" action="<?php echo base_url(); ?>baby_girl_view/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
					...
					<div class="container">
						<div class="row">
										...
										<div class="cd-filter-content">
											<div>
												<label class="checkbox">
													<input type="checkbox" class='babygirl_list' name="babygirl_list[]" value="375" <?php if(isset($sub_cat) && in_array(375,$sub_cat)){ echo 'checked = checked';}?> >
													<i></i> Clothing (<?php echo $cloths; ?>)
												</label>
												<label class="checkbox">
													<input type="checkbox" class='babygirl_list' name="babygirl_list[]" value="376" <?php if(isset($sub_cat) && in_array(376,$sub_cat)){ echo 'checked = checked';}?> >
							...
							<div class="col-md-9">
                                ...
                                <div class="row list_view_searches babygirlresult">
                                	<?php echo $this->load->view("classified/baby_girl_view_search"); ?> 
								</div>
							</div>
						</div>
					</div>
