	...
	<script type="text/javascript">
	  $(function(){
	  	...
	  	$(".dealtitle_sort").change(function(){
	  		var babygirl_list = [];
				$("input[name='babygirl_list[]']:checked").each( function () {
					 var babygirl = $(this).val();
					 	 babygirl_list.push(babygirl);
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url();?>baby_girl_view/search_filters",
					data: {
						babygirl_list: babygirl_list,
										...
										<div class="cd-filter-content">
											<div>
												<label class="checkbox">
													<input type="checkbox" class='babyboy_list' name="babyboy_list[]" value="375" >
													<i></i> Clothing (<?php echo $cloths; ?>)
												</label>
												<label class="checkbox">
													<input type="checkbox" class='babyboy_list' name="babyboy_list[]" value="376" >
