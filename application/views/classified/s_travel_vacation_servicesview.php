...
<title>Travel Services London | Vacation Services In UK | 99 Right Deals</title>

<meta name="description" content="Thousands of travel & vacation services awaiting for you in united kingdom like minibus, car rental, flight, motorhomes, campervan, caravan services on 99 Right Deals." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_travel_vacation_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Travel & vacation</h4>
...
<?php echo $this->load->view("classified/s_travel_vacation_servicesview_search"); ?> 
</div>
