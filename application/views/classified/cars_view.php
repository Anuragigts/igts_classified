	<title>New | Second Hand | Cars For Sale in United Kingdom | 99 Right Deals</title>
	...
	</script><script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?sensor=false&libraries=places"></script>
	<script type="text/javascript">
	...
	<section class="content-central">
		...
		<form id="j-forms2" action="<?php echo base_url(); ?>cars_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
						...
						<div class="row">
							...
							<div class="col-md-3 col-sm-3">
								<div class="container-by-widget-filter bg-dark color-white">
									<!-- Widget Filter -->
									<a href="<?php echo base_url(); ?>cars_view"><h3 class="title-widget">Cars Filter</h3></a>
							...
							<div class="col-md-9 col-sm-9">
								...
								<div class="row list_view_searches cars_result">
                                    <?php echo $this->load->view("classified/cars_view_search"); ?>
								</div>
							</div>
						</div>
					</div>
