...
<title>Motor Services | Motor Repair Services In UK | 99 Right Deals</title>

<meta name="description" content="Browse your latest motor services in united kingdom on 99 Right Deals. And get the free ads for motor repairing services In United Kingdom." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_motor_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Motor Services</h4>
...
<?php echo $this->load->view("classified/s_motor_servicesview_search"); ?> 
</div>
