...
<title>Used Electric Iron For Sale | 99 Right Deals</title>

<meta name="description" content="Find Buy & Sell electric iron in UK. And also get free ads for used or new electric iron for sale on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>ha_electric_ironview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Electric Iron</h4> 
...
<?php echo $this->load->view("classified/ha_electric_ironview_search"); ?>
</div>
</div>
</div>
</div>
