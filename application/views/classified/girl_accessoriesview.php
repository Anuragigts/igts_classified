...
<title>New & Used Girls Accessories For Sale In UK | 99 Right Deals</title>

<meta name="description" content="99 Right Deals has wide range of new & used girls accessories for sale in Unnited Kingdom at affordable price. Place an ads for girls accessories in UK" />
...
<form id="j-forms2" action="<?php echo base_url(); ?>girl_accessoriesview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Girls Accessories</h4>
...
<?php echo $this->load->view("classified/girl_accessoriesview_search"); ?> 
</div>
</div>
</div>
</div>
