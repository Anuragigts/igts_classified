...
<html>
	<head>
		...
		<title>Buy & Sell Used Curtains Accessories For Sale In UK | 99 Right Deals</title>
		
		<meta name="description" content="Shop for new & used curtain accessories for sale in United Kingdom. Buy & Sell used curtain accessories like rods, curtain rings, tiebacks and many more on 99 Right Deals." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>dec_curtains_acceview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white cloth_h3">
											...
											<h4 class="title-widget">Curtains & Accessories</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches kitchen_search_result">
											<?php echo $this->load->view("classified/dec_curtains_acceview_search"); ?>
										</div>
									</div>
								</div>
							</div>
