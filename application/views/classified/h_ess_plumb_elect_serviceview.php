...
<form id="j-forms2" action="<?php echo base_url(); ?>h_ess_plumb_elect_serviceview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Plumbing & Electrician Services</h4>
...
<?php echo $this->load->view("classified/h_ess_plumb_elect_serviceview_search"); ?>
</div>
</div>
</div>
</div>
