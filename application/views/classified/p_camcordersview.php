...
<html>
	<head>
		...
		<title>Professional Digital Camcorder | Sell Used Camcorder - 99 Right Deals</title>
		
		<meta name="description" content="Classifieds ads website for professional digital camcorders for sale in UK on 99 Right Deals. Create free ads for own sell used camcorders." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>p_camcordersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget ">Camcorders</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches motor_result">
											<?php echo $this->load->view("classified/p_camcordersview_search"); ?>
										</div>
									</div>
								</div>
							</div>
