...
<li><a href="javascript:void(0);"><i class="fa fa-star"></i></a></li>
<li><a href="javascript:void(0);"><i class="fa fa-star"></i></a></li>
ef="javascript:void(0);"><i class="fa fa-star-o"></i></a></li>
<li><a href="javascript:void(0);"><i class="fa fa-star-o"></i></a></li>
</ul>
</div>
<?php } ?>
...
if ($sval->bus_logo != '') { ?>
<div class="col-xs-4 serch_bus_logo">
<imgsrc="<?php echo base_url(); ?>pictures/business_logos/<?php echo $sval->bus_logo; ?>" alt="<?php echo $sval->bus_logo; ?>" title="busniess logo" class="img-responsive">
</div>
<?php}
else{ ?>
<div class="col-xs-4 serch_bus_logo">
<imgsrc="<?php echo base_url(); ?>pictures/business_logos/trader-130x50.png" alt="intel" title="intel logo" class="img-responsive">
</div>
<?php}
}
?>
...
<divclass="row">
<div class="col-xs-12">
<pclass=""><?php echo substr(strip_tags($sval->deal_desc), 0,70); ?></p>
</div>
<div class="col-xs-12">
<ahref="<?php echo base_url(); ?>description_view/details/<?php echo $sval->ad_id; ?>/<?php echo str_replace(" ", "-", str_replace("&", "", $sval->deal_tag)); ?>" class="btn_v btn-3 btn-3d descurl fa fa-arrow-right"><span>View Details</span></a>
</div>
</div>
</div>
<div class="col-xs-4">
...
<div class="col-xs-12">
<ahref="#" data-toggle="modal" data-target="#sendnow" <?php echo $sval->ad_id; ?> class="send_now_show btn_v btn-4 btn-4a fa fa-arrow-right top_4"><span>Send Message</span></a>
</div>
</div>
</div>
</div>
...
<div class="price11">
<span></span><b>
<imgsrc="<?php echo base_url(); ?>img/icons/thumb.png" class="pull-right" alt="thumb" title="thumb Icon"></b>
</div>
</div>
</div>
<div class="col-sm-8 middle_text">
