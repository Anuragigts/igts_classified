...
<title>New & Used Inverters  For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Find used Inverters  for Sale in United Kingdom. Buy or Sell online variety of inverters for sale on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>ha_invertersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Inverters</h4> 
...
<?php echo $this->load->view("classified/ha_invertersview_search"); ?>
</div>
</div>
</div>
</div>
