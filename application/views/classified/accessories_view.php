						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="container-by-widget-filter bg-dark color-white">
									<!-- Widget Filter -->
									<h3 class="title-widget">Accessories  </h3>
										...
										<div class="cd-filter-content">
											<div id="limit_scrol">
												<label class="checkbox">
													...
													<i></i> Tablet & iPad Accessories 
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> iPhone Accessories
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Mobile Accessories
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Computer Accessories
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Headphones & Earphones
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Audio Video Accessories
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Camera Accessories
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Inverters, Stablizers & Power
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Battery
