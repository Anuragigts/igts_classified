...
<title>Accounting Services London | Taxation Services In UK | 99 Right Deals</title>

<meta name="description" content="Are you facing problem in Accounting & Taxation and Money? Don't worry, thousands of accounting services or taxation services in UK awaiting for you on 99 Right Deals." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_accounting_taxation_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Accounting & taxation</h4>
...
<?php echo $this->load->view("classified/s_accounting_taxation_servicesview_search"); ?> 
</div>
