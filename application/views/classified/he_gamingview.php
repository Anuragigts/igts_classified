...
<title>New & Used Game For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Find the thousands of Used or New Game for Sale in United Kingdom on 99 Right Deals. And place an ads for your used gaming products." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>he_gamingview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<?php echo $this->load->view("classified/he_gamingview_search"); ?>
</div>
</div>
</div>
</div>
