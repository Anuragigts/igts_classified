...
<title>New & Used Personal And Body Care Stuff For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Shop now new & used personal care stuff like trimmer, shaver, hair dryers, massagers and so on for sale in London, UK on 99 Right Deals." />
...
$pcare_sub12 = $this->session->userdata('pcare_sub');
...
<form id="j-forms2" action="<?php echo base_url(); ?>personal_care_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<?php echo $this->load->view("classified/personal_care_view_search"); ?>
</div>
</div>
</div>
</div>
