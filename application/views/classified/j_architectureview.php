...
<title>Architecture Jobs In London - UK | 99 Right Deals</title>

<meta name="description" content="Search current opening for architecture jobs in United Kingdom on 99 Right Deals. Find jobs online today and get quick respones in United Kingdom." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_architectureview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Architecture</h4>
...
<?php echo $this->load->view("classified/j_architectureview_search"); ?> 
</div>
</div>
</div>
</div>
