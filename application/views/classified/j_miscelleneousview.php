...
<title>Miscelleneous Jobs & Vacanies In London - UK | 99 Right Deals</title>

<meta name="description" content="Search the opening for miscelleneous jobs or vancanies in United Kingdom. And  verious jobs are awaiting for you on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_miscelleneousview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Miscelleneous</h4>
...
<?php echo $this->load->view("classified/j_miscelleneousview_search"); ?> 
</div>
</div>
</div>
</div>
