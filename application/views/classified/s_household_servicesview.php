...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_household_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Household services</h4>
...
<?php echo $this->load->view("classified/s_household_servicesview_search"); ?> 
</div>
