...
<html>
	<head>
		...
		<title>News & Media Jobs In London - United Kingdom | 99 Right Deals</title>
		
		<meta name="description" content="Get the an opportunity in New & Media Jobs in United Kingdom on 99 Right Deals. And make your career as editor, reporter, anchor and many more." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>j_news_mediaview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget "> News & Media</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches jobs_search_result">
											<?php echo $this->load->view("classified/j_news_mediaview_search"); ?> 
										</div>
									</div>
								</div>
							</div>
