...
<title>Used Carpets | Used Flooring For Sale In UK | 99 Right Deals</title>

<meta name="description" content="See latest thousands of ads for new & used carpets and flooring for sale in UK. Varity of carpets like rugs, graphical, printed carpets awaiting for you on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>h_ess_carpets_flooringview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Carpets & Flooring</h4>
...
<?php echo $this->load->view("classified/h_ess_carpets_flooringview_search"); ?>
</div>
</div>
</div>
</div>
