...
<title>Used Mobile Phones For Sale, Smartphones For Sale UK | 99 Right Deals</title>

<meta name="description" content="Create free ads for mobile phones for sale in Manchester United Kingdom on 99 Right Deals. Post free ads for buy or sell mobile phones in UK." />
<meta name="keywords" content="used smartphones for sale, mobile phones for sale online, sell used mobile phones, sell mobile phone, mobile phones for sale, used phones for sale, used cell phones for sale, second hand mobile phones, buy mobile phone online, cheap smartphones for sale" />
...
<form id="j-forms2" action="<?php echo base_url(); ?>pt_mobile_phonesview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<!-- Widget Filter -->
<a href="<?php echo base_url(); ?>e-zone-phones-tablets-sale"><h3 class="title-widget">Ezone</h3></a>

<a href="<?php echo base_url(); ?>used-phones-tablets"><h4 class="title-widget">Phones & Tablets</h4></a>
<h4 class="title-widget">Mobile Phones</h4>
...
<?php echo $this->load->view("classified/pt_mobile_phonesview_search"); ?>
</div>
</div>
</div>
</div>
