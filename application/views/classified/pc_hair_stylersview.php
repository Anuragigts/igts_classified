...
<title>Buy & Sell Used Hair Styler For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Place your an own free classifieds ads for Buy or Sell online Hair Styler for Sale in United Kingdom on 99 Right Deals at best price." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>pc_hair_stylersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Hair Stylers</h4>
...
<?php echo $this->load->view("classified/pc_hair_stylersview_search"); ?>
</div>
</div>
</div>
</div>
