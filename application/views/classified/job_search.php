	<title>365 Deals :: Jobs search</title>
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="container-by-widget-filter bg-dark color-white">
									<!-- Widget Filter -->
									<h3 class="title-widget">Jobs Filter</h3>
									<div class="cd-filter-block">
										...
										<div class="cd-filter-content">
											<div id="limit_scrol">
												...
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Construction & Property Development 
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Sales, Retail & Customer Service 
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Work Wanted
												...
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Driving & Automotive 
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Charity & Voluntary Work
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Part-time, Evening & Weekend
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Housekeeping & Cleaning
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Homecare & Special Care
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Bar Staff & Management 
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Babysitting & Nannies 
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Education
												...
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Health, Beauty & Fitness
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Healthcare, Medicine & Pharmaceutical 
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Admin, Secretarial & PA
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Security
												...
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Marketing, Advertising & PR
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Student & Graduate 
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Farm, Vet, Garden & Landscaping
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i> Computing & IT
									...
									<div class="cd-filter-block">
										<h4 class="title-widget closed"> Contract Type</h4>
									...
									<div class="cd-filter-block">
										<h4 class="title-widget closed">Jobs posted in</h4>
