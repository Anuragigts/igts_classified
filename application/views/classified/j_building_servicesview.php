...
<html>
	<head>
		...
		<title>Building Services Jobs In UK | 99 Right Deals</title>
		
		<meta name="description" content="See the current opening for building services jobs in United Kingdom on 99 Right Deals. Electrician, elevator mechanic, plumber, welder positions are available in UK" />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>j_building_servicesview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget">Building Services</h4>
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches jobs_search_result">
											<?php echo $this->load->view("classified/j_building_servicesview_search"); ?> 
										</div>
									</div>
								</div>
							</div>
