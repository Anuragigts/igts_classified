...
<html>
	<head>
		...
		<title>New & Used Dryers For Sale In UK | 99 Right Deals</title>
		
		<meta name="description" content="Free online advertise for used or new dryers for sale in United Kingdom on 99 Right Deals." />
	...
	<body id="home">
		...
		<div id="layout">
			...
			<section class="content-central">
				...
				<form id="j-forms2" action="<?php echo base_url(); ?>ha_dryersview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
								...
								<div class="row">
									...
									<div class="col-md-3 col-sm-3">
										<div class="container-by-widget-filter bg-dark color-white">
											...
											<h4 class="title-widget">Dryers</h4>  
									...
									<div class="col-md-9 col-sm-9">
										...
										<div class="row list_view_searches motor_result">
											<?php echo $this->load->view("classified/ha_dryersview_search"); ?>
										</div>
									</div>
								</div>
							</div>
