...
<title>New & Used Computer Accessories For Sale In UK | 99 Right Deals</title>

<meta name="description" content="Buy New or Used Computer Accessories for Sale in United Kingdom. Post online Classfieds ads for sound card, graphice card, moniter, speakers on 99 Right Deals" />
...
<form id="j-forms2" action="<?php echo base_url(); ?>a_computer_accessoriesview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Computer Accessories</h4>
...
<?php echo $this->load->view("classified/a_computer_accessoriesview_search"); ?>
</div>
</div>
</div>
</div>
