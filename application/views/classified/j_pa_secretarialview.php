...
<title>Secretarial Jobs | P.A. Jobs In London - UK | 99 Right Deals</title>

<meta name="description" content="Find recent current opening in P.A. and secretarial jobs in United Kingdom. And make your career in verious positions like personal assistant, company secretary, and so on." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>j_pa_secretarialview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">P.A. & Secretarial</h4>
...
<?php echo $this->load->view("classified/j_pa_secretarialview_search"); ?> 
</div>
</div>
</div>
</div>
