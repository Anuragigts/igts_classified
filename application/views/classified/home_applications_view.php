...
<title>New And Second Hand Or Used Home Appliances For Sale In London, UK</title>

<meta name="description" content="Find the homes and kitchen new and used or secondhand appliances for sale in london, UK on 99 Right Deals at best price." />
...
$homes_sub12 = $this->session->userdata('homes_sub');
...
<form id="j-forms2" action="<?php echo base_url(); ?>home_applications_view/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<?php echo $this->load->view("classified/home_applications_view_search"); ?>
</div>
</div>
</div>
</div>
