...
<title>Entertainment Services | Party Services In UK | 99 Right Deals</title>

<meta name="description" content="Get the thousands of entertainment services like party, DJ's, Birthday and many more services in United Kingdom on 99 Right Deals." />
...
<form id="j-forms2" name="jforms"method='post' action="<?php echo base_url(); ?>s_entertainment_servicesview/search_filters" class="jforms j-forms" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget ">Entertainment Services</h4>
...
<?php echo $this->load->view("classified/s_entertainment_servicesview_search"); ?> 
</div>
