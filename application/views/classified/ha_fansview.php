...
<title>Used Ceiling Fans For Sale | Used Fans For Sale In UK | 99 Right Deals</title>

<meta name="description" content="99 Right Deals provides used or second hand fans for sale in United Kingdom. Find also used ceiling fan for sale  on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>ha_fansview/search_filters" method='post' class="j-forms jforms" style="background-color: rgb(255, 255, 255) !important;">
...
<?php echo $this->load->view("classified/ha_fansview_search"); ?>
</div>
</div>
</div>
</div>
