...
function isNumber(e){e=e?e:window.event;var r=e.which?e.which:e.keyCode;return r>31&&(48>r||r>57)?!1:!0}$(function(){$(".sign_type").change(function(){var e=$("input[name='signup_type']:checked").val();6==e?($("#signup_business").css("display","block"),$("#signup_consumer").css("display","none")):7==e&&($("#signup_business").css("display","none"),$("#signup_consumer").css("display","block"))}),$.validator.addMethod("pwcheck",function(e){return/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d).+$/.test(e)}),jQuery.validator.addMethod("character",function(e){return/^[a-zA-Z\s]+$/.test(e)}),$("#register_form").validate({rules:{con_fname:{required:!0,character:!0,minlength:3},con_lname:{required:!0,character:!0,minlength:3},con_mobile:{required:!0,minlength:11},con_email:{required:!0,email:!0},con_password:{required:!0,minlength:8,pwcheck:!0},bus_fname:{required:!0,character:!0,minlength:3},bus_lname:{required:!0,character:!0,minlength:3},bus_name:{required:!0,minlength:5},bus_address:{required:!0,minlength:5},bus_mobile:{required:!0,minlength:11},bus_email:{required:!0,email:!0},bus_password:{required:!0,minlength:8,pwcheck:!0}},messages:{con_fname:{required:"Please enter your First name",character:"please Enter characters only",minlength:"Enter atleast 3 characters"},con_lname:{required:"Please enter your Last name",character:"please Enter characters only",minlength:"Enter atleast 3 characters"},con_mobile:{required:"Please enter your 11 Digit Mobile No",minlength:"Mobile number Should be 11 digits"},bus_fname:{required:"Please enter your First name",character:"please Enter characters only",minlength:"Enter atleast 3 characters"},bus_lname:{required:"Please enter your Last name",character:"please Enter characters only",minlength:"Enter atleast 3 characters"},bus_name:{required:"Please enter your Business name",minlength:"Enter atleast 5 characters"},bus_address:{required:"Please enter your Business Address",minlength:"Enter atleast 5 characters"},bus_mobile:{required:"Please enter your 11 Digit Mobile No",minlength:"Mobile number Should be 11 digits"},bus_password:{required:"Please provide a password",minlength:"Your password must be at least 8 characters long",pwcheck:"Should Include atleast one lowercase, one uppercase, one digit"},con_password:{required:"Please provide a password",minlength:"Your password must be at least 8 characters long",pwcheck:"Should Include atleast one lowercase, one uppercase, one digit"},con_email:"Please enter a valid email address",bus_email:"Please enter a valid email address"},submitHandler:function(e){return!0}})});
</script>
</head>
