										...
										<div class="cd-filter-content">
											<div class="filters_categories">	
												<ul class="list-styles">
													...
													<li><i class="fa fa-arrow-circle-o-right"></i> <a href="decor_view" class="active_filter">Decor </a></li>
												</ul>
											</div>
										</div>
									</div> 
										...
										<div class="cd-filter-content">
											<div id="limit_scrol">
												<label class="checkbox">
													...
													<i></i>  Curtains & Accessories
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Candles & Fragrances
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Vases & Flowers
												...
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Religion & Spirituality
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Photo frames & Albums
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Rugs & Carpets
												...
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Table Lamps & Ceiling Lights
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Wall & Outdoor Lights
												</label>
												<label class="checkbox">
													<input type="checkbox" name="" value="" >
													<i></i>  Others
