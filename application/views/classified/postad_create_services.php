...
<title>Post a Deal Services | 99 Right Deals</title>
...
<script type='text/javascript'>
$(document).on("keydown",function(e){8!==e.which||$(e.target).is("input, textarea")||(window.location.replace("<?php echo base_url(); ?>"),e.preventDefault())}),$(document).on("keydown",function(e){8!==e.which||$(e.target).is("input, textarea")||$("input").select(function(){window.location.replace("<?php echo base_url(); ?>"),e.preventDefault()})});
</script>
