...
<title>New & Used Dining Table Furniture For Sale In UK - 99 Right Deals</title>

<meta name="description" content="Shop for new & used dining room furniture for sale in United Kingdom at affordable price and also get the hot deals on 99 Right Deals." />
...
<form id="j-forms2" action="<?php echo base_url(); ?>h_ess_dining_room_furview/search_filters" class="j-forms jforms" method="post" style="background-color: rgb(255, 255, 255) !important;">
...
<h4 class="title-widget">Dining Room Furniture</h4>
...
<?php echo $this->load->view("classified/h_ess_dining_room_furview_search"); ?>
</div>
</div>
</div>
</div>
