...
var nicEditorConfig = bkClass.extend({
	...
	buttonList : ['save','fontSize', 'bold','italic','underline','left','center','right','justify','ol','ul','forecolor',/*,'fontFamily'*/,'fontFormat'/*,'indent','outdent','image','upload','link','unlink','forecolor','bgcolor'*/],
...
var nicEditorFontFormatSelect = nicEditorSelect.extend({
    ...
    init: function() {
        ...
        for (itm in this.sel) {
            ...
            this.add("<" + A + ">", "<" + itm + ' style="padding: 2px; margin: 0px;">' + this.sel[itm] + "</" + A + ">")
        }
    }
});
